...
void lora_receive_fill_buffer()
{
    uint8_t rx_data[64] = { 0 };
    uint8_t tx_data[] = "test_fill_buffer";
    uint8_t counter = 0;
    int16_t ret = 0;
...
*/
    ...
    while (1) {
        ...
        */
        ...
        // Success on RX_ERROR, buffer is full
...
Case cases[] = {
    Case("RX, fill receive buffer", lora_receive_fill_buffer, greentea_failure_handler)
};
