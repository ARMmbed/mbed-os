...
static const TestCommand_t SEQUENCES[SEQUENCE_MAX][MAX_STEP] = {
    ...
    /* ERASE_TEST */
    { START_SESSION, WRITE_SIZE_4, WRITE_4_BYTES, READ_4_BYTES, ERASE_4_BYTES,
      READ_4_BYTES_ERASED, END_SESSION, TERMINATE },
    ...
    /* TRUNCATE_TEST */
    { START_SESSION, WRITE_SIZE_4, WRITE_4_BYTES, READ_4_BYTES, WRITE_SIZE_2,
      READ_SIZE_2, READ_4_BYTES_FAIL, END_SESSION, TERMINATE },
