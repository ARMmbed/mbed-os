...
int SPINANDBlockDevice::read_spare(void *buffer, bd_addr_t addr, bd_size_t size)
{
    int status = SPINAND_BD_ERROR_OK;
...
int SPINANDBlockDevice::program_spare(const void *buffer, bd_addr_t addr, bd_size_t size)
{
    qspi_status_t result = QSPI_STATUS_OK;
    bool program_failed = false;
    int status = SPINAND_BD_ERROR_OK;
