...
#ifndef MBED_CONF_MBED_CLIENT_CLI_MAXIMUM_INPUT_LINE_LENGTH
#define MBED_CONF_MBED_CLIENT_CLI_MAXIMUM_INPUT_LINE_LENGTH 64
#endif

#define MAX_LINE MBED_CONF_MBED_CLIENT_CLI_MAXIMUM_INPUT_LINE_LENGTH

// Maximum number of arguments in a single command
#ifndef MBED_CONF_MBED_CLIENT_CLI_MAXIMUM_ARG_COUNT
#define MBED_CONF_MBED_CLIENT_CLI_MAXIMUM_ARG_COUNT 16
#endif

#define MAX_ARGUMENTS MBED_CONF_MBED_CLIENT_CLI_MAXIMUM_ARG_COUNT

// Maximum number of commands saved in history
#ifndef MBED_CONF_MBED_CLIENT_CLI_HISTORY_SIZE
#define MBED_CONF_MBED_CLIENT_CLI_HISTORY_SIZE 16
#endif
