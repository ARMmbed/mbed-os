 ...
 *  @param dns_addr  DNS server host address.
 *  @param interface_name  Network interface name
 *  @return         NSAPI_ERROR_OK on success, negative error code on failure.
 */
nsapi_error_t nsapi_dns_get_server(NetworkStack *stack, uint8_t index, SocketAddress *dns_addr, const char *interface_name);
