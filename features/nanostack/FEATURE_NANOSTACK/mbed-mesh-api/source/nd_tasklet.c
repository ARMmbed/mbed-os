...
// 6LoWPAN device configuration
#ifndef MBED_CONF_MBED_MESH_API_6LOWPAN_ND_DEVICE_TYPE

#ifdef FEATURE_LOWPAN_ROUTER

#define MBED_CONF_MBED_MESH_API_6LOWPAN_ND_DEVICE_TYPE NET_6LOWPAN_ROUTER

#elif defined(FEATURE_LOWPAN_HOST)// FEATURE_LOWPAN_ROUTER

#ifdef MBED_CONF_MBED_MESH_API_SLEEPY_DEVICE

#if MBED_CONF_MBED_MESH_API_SLEEPY_DEVICE == 1

#define MBED_CONF_MBED_MESH_API_6LOWPAN_ND_DEVICE_TYPE NET_6LOWPAN_SLEEPY_HOST
#else
#define MBED_CONF_MBED_MESH_API_6LOWPAN_ND_DEVICE_TYPE NET_6LOWPAN_HOST
...
#else // FEATURE_LOWPAN_HOST

#define MBED_CONF_MBED_MESH_API_6LOWPAN_ND_DEVICE_TYPE NET_6LOWPAN_ROUTER

#endif // FEATURE_LOWPAN_HOST

#endif // MBED_CONF_MBED_MESH_API_6LOWPAN_ND_DEVICE_TYPE
