 ...
 */
#ifndef __FHSS_MAC_INTERFACE_STUB_H__
#define __FHSS_MAC_INTERFACE_STUB_H__
...
typedef struct {
    ...
    bool cond_bool_value;
    bool queue_bool_value;
    int handle_value;
    int8_t int8_value;
    uint32_t uint32_value;
} fhss_mac_interface_stub_def;

extern fhss_mac_interface_stub_def fhss_mac_interface_stub;
...
#endif // __FHSS_MAC_INTERFACE_STUB_H__
