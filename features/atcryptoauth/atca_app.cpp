...
/** Sample configuration data CRC. It is supplied to the Lock command to
 *  match the device configuration up to this CRC before locking. Hence it
 *  protects against most accidental errors.
 *
 *  Sample configuration on which this CRC is calculated is:
 *  0x01, 0x23, 0x95, 0x11,
 *  0x00, 0x00, 0x50, 0x00,
 *  0x5D, 0xCF, 0xD6, 0xCD,
 *  0xEE, 0xC0, 0x1D, 0x00,
 ...
 *  0x10, 0x00, 0x1C, 0x00
 */
uint16_t atcaecc508a_sample_config_crc = 0xFFED;
