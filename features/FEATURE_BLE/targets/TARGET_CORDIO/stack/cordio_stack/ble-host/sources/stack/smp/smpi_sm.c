...
/* Event                        Next state                  Action */
  ...
  {SMP_MSG_INT_TIMEOUT,         SMPI_SM_ST_IDLE,            SMPI_ACT_PAIRING_FAILED},
  {0,                           0,                          0}
};
...
/* Event                        Next state                  Action  */
  ...
  {SMP_MSG_INT_TIMEOUT,         SMPI_SM_ST_IDLE,            SMPI_ACT_NONE},
  {0,                           0,                          0}
};
...
{
/* Event                        Next state                  Action  */
  {SMP_MSG_INT_TIMEOUT,         SMPI_SM_ST_IDLE,            SMPI_ACT_CHECK_ATTEMPTS},
