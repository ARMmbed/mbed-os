...
/* Event                        Next state                  Action */
  ...
  {SMP_MSG_INT_TIMEOUT,         SMPI_SC_SM_ST_IDLE,            SMPI_SC_ACT_PAIRING_FAILED},
  {0,                           0,                          0}
};
...
/* Event                        Next state                  Action  */
  ...
  {SMP_MSG_INT_TIMEOUT,         SMPI_SC_SM_ST_IDLE,            SMPI_SC_ACT_NONE},
  {0,                           0,                          0}
};
...
{
/* Event                        Next state                  Action  */
  {SMP_MSG_INT_TIMEOUT,         SMPI_SC_SM_ST_IDLE,            SMPI_SC_ACT_CHECK_ATTEMPTS},
