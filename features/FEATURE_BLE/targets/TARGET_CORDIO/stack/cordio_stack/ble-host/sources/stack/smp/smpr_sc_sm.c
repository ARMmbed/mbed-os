...
enum
{
  ...
  SMPR_SC_ACT_CHECK_SECURITY_REQ,   /*!< Process Check Slave Security Request */
  SMPR_SC_ACT_CLEAR_SECURITY_REQ,   /*!< Process Clear Slave Security Request */
...
/* Event                        Next state                                Action */
  ...
  {SMP_MSG_INT_TIMEOUT,         SMPR_SC_SM_ST_IDLE,                          SMPR_SC_ACT_PAIRING_FAILED},
  {0,                           0,                                        0}
};
...
{
/* Event                        Next state                                Action  */
  {SMP_MSG_API_SECURITY_REQ,    SMPR_SC_SM_ST_IDLE,                          SMPR_SC_ACT_SEND_SECURITY_REQ},
  {SMP_MSG_DM_CONN_CLOSE,       SMPR_SC_SM_ST_IDLE,                          SMPR_SC_ACT_CLEANUP},
  {SMP_MSG_DM_ENCRYPT_CMPL,     SMPR_SC_SM_ST_IDLE,                          SMPR_SC_ACT_CLEAR_SECURITY_REQ},
  {SMP_MSG_DM_ENCRYPT_FAILED,   SMPR_SC_SM_ST_IDLE,                          SMPR_SC_ACT_CLEAR_SECURITY_REQ},
  {SMP_MSG_CMD_PKT,             SMPR_SC_SM_ST_API_PAIR_RSP,                  SMPR_SC_ACT_PROC_PAIR_REQ},
  {SMP_MSG_CMD_PAIRING_FAILED,  SMPR_SC_SM_ST_IDLE,                          SMPR_SC_ACT_CHECK_SECURITY_REQ},
  {SMP_MSG_API_CANCEL_REQ,      SMPR_SC_SM_ST_IDLE,                          SMPR_SC_ACT_CLEANUP},
  {SMP_MSG_INT_TIMEOUT,         SMPR_SC_SM_ST_IDLE,                          SMPR_SC_ACT_NONE},
  {0,                           0,                                        0}
};
...
{
/* Event                        Next state                                Action  */
  {SMP_MSG_INT_TIMEOUT,         SMPR_SC_SM_ST_IDLE,                          SMPR_SC_ACT_CHECK_ATTEMPTS},
