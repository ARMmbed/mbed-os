...
struct SimpleAttFindInformationResponse : public AttFindInformationResponse {
    ...
    SimpleAttFindInformationResponse(
        Format format, array_view<const uint8_t> information_data
...
private:
    ...
    const array_view<const uint8_t> _information_data;
...
struct SimpleAttFindByTypeValueResponse : public AttFindByTypeValueResponse {
     ...
     */
    SimpleAttFindByTypeValueResponse(array_view<const uint8_t> handles) :
...
private:
    ...
    const array_view<const uint8_t> _handles;
};
...
struct SimpleAttReadByTypeResponse : public AttReadByTypeResponse {
    ...
    SimpleAttReadByTypeResponse(
        uint8_t element_size, array_view<const uint8_t> attribute_data
...
private:
    array_view<const uint8_t> _attribute_data;
