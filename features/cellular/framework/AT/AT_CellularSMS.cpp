...
AT_CellularSMS::AT_CellularSMS(ATHandler &at, CellularDevice& device) : _cb(0), _mode(CellularSMSMmodeText),
...
{
    if (!_device.get_property(CellularDevice::PROPERTY_AT_CNMI)) {
...
{
    if (!_device.get_property(CellularDevice::PROPERTY_AT_CMGF)) {
        return NSAPI_ERROR_UNSUPPORTED;
    }
...
{
    if (!_device.get_property(CellularDevice::PROPERTY_AT_CSMP)) {
        return NSAPI_ERROR_UNSUPPORTED;
    }
...
{
    if (!_device.get_property(CellularDevice::PROPERTY_AT_CSDH)) {
        return NSAPI_ERROR_UNSUPPORTED;
    }
