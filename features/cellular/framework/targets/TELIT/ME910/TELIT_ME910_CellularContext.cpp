...
{
    bool modem_supports_ipv6 = _device->get_property(CellularDevice::PROPERTY_IPV6_PDP_TYPE);
    bool modem_supports_ipv4 = _device->get_property(CellularDevice::PROPERTY_IPV4_PDP_TYPE);
    ...
    while (_at.info_resp()) {
        ...
        if (pdp_type_len > 0) {
            ...
            if (apn_len >= 0) {
                ...
                if (_device->get_property(pdp_type_t_to_cellular_property(pdp_type)) ||
