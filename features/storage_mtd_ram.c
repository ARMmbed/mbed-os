...
#ifdef DEVICE_STORAGE_CONFIG_HARDWARE_MTD_RAM_ERASE_UNIT
#define ERASE_UNIT           (DEVICE_STORAGE_CONFIG_HARDWARE_MTD_RAM_ERASE_UNIT)
#else
#define ERASE_UNIT           (4096UL)
#endif

#ifdef DEVICE_STORAGE_CONFIG_HARDWARE_MTD_RAM_STORAGE_START_ADDR
#define STORAGE_START_ADDR   (DEVICE_STORAGE_CONFIG_HARDWARE_MTD_RAM_STORAGE_START_ADDR)
#else
#define STORAGE_START_ADDR   (0x00000UL)
#endif

#ifdef DEVICE_STORAGE_CONFIG_HARDWARE_MTD_RAM_STORAGE_SIZE
#define STORAGE_SIZE         (DEVICE_STORAGE_CONFIG_HARDWARE_MTD_RAM_STORAGE_SIZE)
#else
#define STORAGE_SIZE         (0x8000UL)
#endif

#ifdef DEVICE_STORAGE_CONFIG_HARDWARE_MTD_RAM_PROGRAM_UNIT
#define PROGRAM_UNIT         (DEVICE_STORAGE_CONFIG_HARDWARE_MTD_RAM_PROGRAM_UNIT)
#else
#define PROGRAM_UNIT         (1UL)
#endif

#ifdef DEVICE_STORAGE_CONFIG_HARDWARE_MTD_RAM_OPTIMAL_PROGRAM_UNIT
#define OPTIMAL_PROGRAM_UNIT (DEVICE_STORAGE_CONFIG_HARDWARE_MTD_RAM_OPTIMAL_PROGRAM_UNIT)
#else
#define OPTIMAL_PROGRAM_UNIT (1024UL)
#endif

#ifdef DEVICE_STORAGE_CONFIG_HARDWARE_MTD_RAM_BLOCK_COUNT
#define NUM_BLOCKS DEVICE_STORAGE_CONFIG_HARDWARE_MTD_RAM_BLOCK_COUNT
#else
#define NUM_BLOCKS 1
#endif
