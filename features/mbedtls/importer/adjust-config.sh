...
#also add #includes so we can use the Mbed OS configuration system
add_code                                                                                            \
...
add_code                                                                                                                                   \
    ...
    "\n"                                                                                                                                   \
    "#endif \/* else !MBEDTLS_ENTROPY_HARDWARE_ALT && !MBEDTLS_TEST_NULL_ENTROPY && !MBEDTLS_ENTROPY_NV_SEED *\/\n"                        \
    "\n"                                                                                                                                   \
