...
uint8_t thread_nd_prefix_based_on_list_entry_size(thread_network_service_entry_t *entry, bool fullList)
{
    return 0;
}
...
thread_network_service_entry_t *thread_prefix_service_list_allocate(thread_prefix_tlv_t *prefixTlv)
{
    return NULL;
}
...
thread_network_local_data_entry_t *thread_get_local_prefix_entry(thread_network_local_data_list_t *list, thread_prefix_tlv_t *prefixTlv)
{
    return NULL;
}

thread_network_local_data_entry_t *thread_get_local_prefix_list(thread_network_local_data_list_t *list, thread_prefix_tlv_t *prefixTlv)
{
    return NULL;
}

thread_network_service_entry_t *thread_get_main_prefix_entry(thread_network_servive_list_t *list, thread_prefix_tlv_t *prefixTlv)
{
    return NULL;
}

thread_network_service_entry_t *thread_get_main_prefix_list(thread_network_servive_list_t *list, thread_prefix_tlv_t *prefixTlv)
{
    return NULL;
}
...
int threah_server_context_delete_mark(thread_data_context_list_t *listPtr)
{
    return 0;
}

int threah_server_data_delete_mark_by_router_id(thread_network_server_data_list_t *listPtr, uint16_t routerID, bool subSet)
{
    return 0;
}

int threah_server_context_clean(thread_network_data_cache_entry_t *cachePtr, thread_data_context_list_t *listPtr, thread_network_service_entry_t *prefixEntry)
{
    return 0;
}


void threah_server_data_clean_by_router_id(thread_network_data_cache_entry_t *cachePtr, thread_network_server_data_list_t *listPtr, thread_network_service_entry_t *prefixEntry, bool routeInfo, protocol_interface_info_entry_t *curInterface)
{
}
...
void thread_network_data_router_id_free(thread_network_data_cache_entry_t *cachePtr, bool subSet, protocol_interface_info_entry_t *curInterface)
{
}

void thread_network_data_context_re_use_timer_update(thread_network_data_cache_entry_t *cachePtr, uint32_t ticks)
{
...
int thread_local_server_list_del_on_mesh_server(thread_network_local_data_cache_entry_t *networkDataList, thread_prefix_tlv_t *prefixTlv, bool slaacService)
{
    return 0;
}
...
bool thread_check_network_data_prefix_stable_boolean(thread_network_service_entry_t *dataList)
{
    return false;
}
