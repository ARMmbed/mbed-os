...
typedef uint_fast4_t route_cost_t;
...
thread_link_quality_t link_margin_to_quality(thread_link_margin_t margin)
{
    return QUALITY_BAD;
}
...
void thread_routing_get_mask_by_current_data(thread_routing_info_t *routing, uint8_t *id_mask)
{
}
...
uint_fast8_t thread_routing_count_neighbours_with_quality_or_better(thread_routing_info_t *routing, thread_link_quality_t quality)
{
    return 0;
}
