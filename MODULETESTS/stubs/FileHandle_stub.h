...
static bool filehandle_stub_use_read_array = false;
static char filehandle_stub_read_array[30][32] = {};
static uint8_t filehandle_stub_read_array_pos = 0;
...
public:
    ...
    {
        if (filehandle_stub_use_read_array) {
            ssize_t ret = strlen(filehandle_stub_read_array[filehandle_stub_read_array_pos]);
            memcpy(buffer, filehandle_stub_read_array[filehandle_stub_read_array_pos], ret);
            filehandle_stub_read_array_pos++;
            return ret;
        } else if (filehandle_stub_table) {
