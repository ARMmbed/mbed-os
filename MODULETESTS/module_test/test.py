...
class ModuleTestTool(object):
    ...
    def build_tests(self):
        """
        Build module tests and libraries to be tested.
        """
        ...
        execute_program(args,
                        "Building module tests failed.",
                        "Module tests built successfully.")
    ...
    def run_tests(self, filter_regex=None):
        ...
        execute_program(args, "Module test run failed.")
