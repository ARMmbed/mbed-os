...
def get_options_parser():
    """
    Create a module test options parser.
    ...
    parser.add_argument("--compile",
                        action="store_true",
                        help="Only compile module tests",
                        dest="compile_only")

    parser.add_argument("--run",
                        action="store_true",
                        help="Only run module tests",
                        dest="run_only")
    ...
    parser.add_argument("--build",
                        default="build",
                        help="Build directory. Default: MODULETESTS/build/",
                        dest="build")
...
""")
    ...
    logging.info(" [%s]  \tBuild module tests", status)
    ...
    logging.info(" [%s]  \tRun module tests", status)
