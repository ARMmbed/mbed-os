...
Arm Mbed OS is an open source embedded operating system designed specifically for the _"things"_ in the Internet of Things. It includes all the features you need to develop a connected product based on an Arm Cortex-M microcontroller, including security, connectivity, an RTOS and drivers for sensors and I/O devices.
