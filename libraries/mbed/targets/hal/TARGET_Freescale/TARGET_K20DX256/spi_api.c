...
static const PinMap PinMap_SPI_SCLK[] = { // SCK
    {PTC5, SPI_0, 2},
    {PTD1, SPI_0, 2},
    {NC  , NC   , 0}
};

static const PinMap PinMap_SPI_MOSI[] = { // DOUT
    {PTD2, SPI_0, 2},
    {PTC6, SPI_0, 2},
    {NC  , NC   , 0}
};

static const PinMap PinMap_SPI_MISO[] = { // DIN
    {PTD3, SPI_0, 2},
    {PTC7, SPI_0, 2},
    {NC  , NC   , 0}
};

static const PinMap PinMap_SPI_SSEL[] = { // CS
    {PTD0, SPI_0, 2},
    {PTC4, SPI_0, 2},
    {PTD4, SPI_0, 2},
    {PTC3, SPI_0, 2},
