...
static control_t cfstore_find2_test_01(const size_t call_count)
{
	...
	//todo: ARM: ARM_CFSTORE_CAPABILITIES cap;
	...
	// Read the config store capabilities
	//todo: ARM: cap = cfstore_driver.GetCapabilities();
	//todo: ARM: remove printf("cfstore capabilities:\nasync: %" PRIu32 "\nuvisor: %" PRIu32 "\n", cap.asynchronous_ops, cap.uvisor_support_enabled);
