 ...
 * ** KNOWN ISSUE **
 * The following subsequence causes the KV to erase:
 * - writing some key value store
 * - flush
 * - flush
 * - uninitialise
 * - initialise
 * - open fails with -1002 (key not found) when trying to open the first key value store
 */
