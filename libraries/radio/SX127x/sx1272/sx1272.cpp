                ...
                isRadioActive( false )
{
    ...
    this->dioIrq[0] = static_cast< DioIrqHandler > (&SX1272::OnDio0Irq);
    this->dioIrq[1] = static_cast< DioIrqHandler > (&SX1272::OnDio1Irq);
    this->dioIrq[2] = static_cast< DioIrqHandler > (&SX1272::OnDio2Irq);
