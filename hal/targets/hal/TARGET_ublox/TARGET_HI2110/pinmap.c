 ...
 * in which the Boudica chip is mounted, hence the use of conditional
 * compilation below.
 */
...
static inline volatile unsigned long * func_reg (PinName pin)
{
...
{
    volatile unsigned long *pio_func_reg;
