...
/*
 * DualTimer_DisableInterrupt(): disables timer all interrupts
 * dtimer: dualtimer on which interrupt is disabled
 * single_timer: single timer in the dualtimer on which
 *               interrupt is disabled
 */
void DualTimer_DisableInterrupts(uint32_t dualtime,
