...
TEST_F(TestAT_CellularDevice, test_AT_CellularDevice_get_at_handler)
{
    ...
    CellularDevice_stub::handler_value = CellularDevice_stub::handler_at_constructor_value;
...
TEST_F(TestAT_CellularDevice, test_AT_CellularDevice_close_information)
{
    ...
    ATHandler_stub::fh_value = NULL;
    CellularDevice_stub::handler_value = NULL;
    dev.close_information();

    EventQueue que;
    ATHandler_stub::fh_value = &fh1;
    ATHandler at(&fh1, que, 0, ",");
    CellularDevice_stub::handler_value = &at;
