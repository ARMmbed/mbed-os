...
#ifndef QCA400X_INTERFACE_H
#define QCA400X_INTERFACE_H
...
/** QCA400XInterface interface class
 *  Implementation of the NetworkStack for QCA 4002/4004
 */
class QCA400XInterface : public NetworkStack, public WiFiInterface {
public:
    /**
     * @brief QCA400XInterface default constructor
     */
    QCA400XInterface();

    /**
     * @brief QCA400XInterface default destructor
     */
    virtual ~QCA400XInterface();
...
protected:
     ...
     *        immediately return NSAPI_ERROR_WOULD_WAIT
     */
    virtual int socket_recvfrom(void *handle, SocketAddress *address, void *data, unsigned size);

    /** Register a callback on state change of the socket
     *  @param handle          Socket handle
     *  @param attach_callback Function to call on state change
     *  @param data            Argument to pass to callback
     *  @note Callback may be called in an interrupt context.
     */
    virtual void socket_attach(void *handle, void (*attach_callback)(void *), void *data);
