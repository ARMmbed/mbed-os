...
public:
     ...
     */
    OSPIFBlockDevice(PinName io0, PinName io1, PinName io2, PinName io3, PinName io4, PinName io5, PinName io6, PinName io7, PinName sclk, PinName csel, PinName dqs,
                     int clock_mode, int freq = MBED_CONF_OSPIF_OSPI_FREQ);
...
private:
    ...
    bool _need_define_sfdp_para;
    uint8_t _sfdp_head_table[32];
    uint8_t _sfdp_basic_param_table[64];
    uint8_t _sfdp_4_byte_inst_table[8];
};
