...
/****************************/
#define OSPIF_DEFAULT_PAGE_SIZE  256
...
int OSPIFBlockDevice::init()
{
    ...
    _sfdp_info.fbatbl.addr = 0x0;
    _sfdp_info.fbatbl.size = 0;
    ...
    if ((_sfdp_info.smptbl.addr != 0) && (0 != _sfdp_info.smptbl.size)) {
        ...
        if (sfdp_parse_sector_map_table(callback(this, &OSPIFBlockDevice::_ospi_send_read_sfdp_command),
                                        _sfdp_info.smptbl) < 0) {
                                                    ...
                                                    sfdp_hdr_info &sfdp_info)
{
    ...
    // 4 byte addressing is not currently supported with the Nordic OSPI controller
    if (_attempt_4_byte_addressing) {
        if (_sfdp_detect_and_enable_4byte_addressing(param_table, sfdp_info.bptbl.size) != OSPIF_BD_ERROR_OK) {
...
//            _attempt_4_byte_addressing = false;
            //The sfdp parameter values in Macronix ocata flash(memory type ID is 0x85) are all 0xFF,
            // so we need to define the parameter values by software to support SFDP parsing.
            if (vendor_device_ids[1] == 0x85) {
                _need_define_sfdp_para = true;
                _sfdp_head_table[0] = 0x53;
                _sfdp_head_table[1] = 0x46;
                _sfdp_head_table[2] = 0x44;
                _sfdp_head_table[3] = 0x50;
                _sfdp_head_table[4] = 0x06;
                _sfdp_head_table[5] = 0x01;
                _sfdp_head_table[6] = 0x02;
                _sfdp_head_table[7] = 0xFF;
                _sfdp_head_table[8] = 0x00;
                _sfdp_head_table[9] = 0x06;
                _sfdp_head_table[10] = 0x01;
                _sfdp_head_table[11] = 0x10;
                _sfdp_head_table[12] = 0x30;
                _sfdp_head_table[13] = 0x00;
                _sfdp_head_table[14] = 0x00;
                _sfdp_head_table[15] = 0xFF;
                _sfdp_head_table[16] = 0xC2;
                _sfdp_head_table[17] = 0x00;
                _sfdp_head_table[18] = 0x01;
                _sfdp_head_table[19] = 0x04;
                _sfdp_head_table[20] = 0x10;
                _sfdp_head_table[21] = 0x01;
                _sfdp_head_table[22] = 0x00;
                _sfdp_head_table[23] = 0xFF;
                _sfdp_head_table[24] = 0x84;
                _sfdp_head_table[25] = 0x00;
                _sfdp_head_table[26] = 0x01;
                _sfdp_head_table[27] = 0x02;
                _sfdp_head_table[28] = 0xC0;
                _sfdp_head_table[29] = 0x00;
                _sfdp_head_table[30] = 0x00;
                _sfdp_head_table[31] = 0xFF;

                _sfdp_basic_param_table[0] = 0x30;
                _sfdp_basic_param_table[2] = 0xFB;
                _sfdp_basic_param_table[7] = 0x1F;
                _sfdp_basic_param_table[4] = 0xFF;
                _sfdp_basic_param_table[5] = 0xFF;
                _sfdp_basic_param_table[6] = 0xFF;
                _sfdp_basic_param_table[17] = 0x01;
                _sfdp_basic_param_table[18] = 0x14;
                _sfdp_basic_param_table[19] = 0xEC;
                _sfdp_basic_param_table[28] = 0x0C;
                _sfdp_basic_param_table[29] = 0x20;
                _sfdp_basic_param_table[30] = 0x10;
                _sfdp_basic_param_table[31] = 0xDC;
                _sfdp_basic_param_table[32] = 0x00;
                _sfdp_basic_param_table[33] = 0xFF;
                _sfdp_basic_param_table[34] = 0x00;
                _sfdp_basic_param_table[35] = 0xFF;
                _sfdp_basic_param_table[40] = 0x81;
                _sfdp_basic_param_table[61] = 0x50;
                _sfdp_basic_param_table[62] = 0xF9;
                _sfdp_basic_param_table[63] = 0x80;

                _sfdp_4_byte_inst_table[0] = 0x7F;
                _sfdp_4_byte_inst_table[1] = 0xEF;
                _sfdp_4_byte_inst_table[2] = 0xFF;
                _sfdp_4_byte_inst_table[3] = 0xFF;
                _sfdp_4_byte_inst_table[4] = 0x21;
                _sfdp_4_byte_inst_table[5] = 0x5C;
                _sfdp_4_byte_inst_table[6] = 0xDC;
                _sfdp_4_byte_inst_table[7] = 0x14;
            }
            break;
    }
