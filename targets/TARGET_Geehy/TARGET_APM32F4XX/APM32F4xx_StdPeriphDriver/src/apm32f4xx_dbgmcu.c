 ...
 *                    @arg DBGMCU_TMR6_STOP          : TMR6 counter stopped when Core is halted(Not for APM32F411)
 *                    @arg DBGMCU_TMR7_STOP          : TMR7 counter stopped when Core is halted(Not for APM32F411)
