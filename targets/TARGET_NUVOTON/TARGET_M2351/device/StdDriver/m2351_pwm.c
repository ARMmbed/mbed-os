 ...
 * @file     pwm.c
 * @version  V3.00
 * @brief    M2351 series PWM driver source file
 *
 * @note
...
{
    (pwm)->STATUS = (PWM_STATUS_EADCTRGF0_Msk << u32ChannelNum);
}
...
{
    return (((pwm)->STATUS & (PWM_STATUS_EADCTRGF0_Msk << u32ChannelNum)) ? 1 : 0);
}
