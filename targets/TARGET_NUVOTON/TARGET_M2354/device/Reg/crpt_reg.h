...
typedef struct
{
    ...
    uint32_t RESERVE7[42];

    __IO uint32_t RSA_CTL;              /* Offset 0xB00:        RSA Control Register                           */
    __IO uint32_t RSA_STS;              /* Offset 0xB04:        RSA Status Register                            */
    __IO uint32_t RSA_SADDR[5];         /* Offset 0xB08:        RSA DMA Source Address Register                */
    __IO uint32_t RSA_DADDR;            /* Offset 0xB1C:        RSA DMA Destination Address Register           */
    __IO uint32_t RSA_MADDR[7];         /* Offset 0xB20:        RSA DMA Destination Address Register           */

    uint32_t RESERVE8[241];
    
    __IO uint32_t PRNG_KSCTL; // 0xf00
    __IO uint32_t PRNG_KSSTS; // 0xf04
    uint32_t RESERVE9[2];
    __IO uint32_t AES_KSCTL;  // 0xf10
    uint32_t RESERVE10[7];
    __IO uint32_t HMAC_KSCTL; // 0xf30
    uint32_t RESERVE11[3];
    __IO uint32_t ECC_KSCTL; // 0xf40
    __IO uint32_t ECC_KSSTS; // 0xf44
    ...
    __IO uint32_t RSA_KSSTS[2];          /*!< [0x0f54] ~ [0x0f58] RSA Key Status Register 0~1                           */
...
#define CRPT_INTEN_RSAIEN_Pos            (30)                                              /*!< CRPT INTEN: RSAIEN Position            */
#define CRPT_INTEN_RSAIEN_Msk            (0x1ul << CRPT_INTEN_RSAIEN_Pos)                  /*!< CRPT INTEN: RSAIEN Mask                */

#define CRPT_INTEN_RSAEIEN_Pos           (31)                                              /*!< CRPT INTEN: RSAEIEN Position           */
#define CRPT_INTEN_RSAEIEN_Msk           (0x1ul << CRPT_INTEN_RSAEIEN_Pos)                 /*!< CRPT INTEN: RSAEIEN Mask               */
...
#define CRPT_INTSTS_RSAIF_Pos            (30)                                              /*!< CRPT INTSTS: RSAIF Position            */
#define CRPT_INTSTS_RSAIF_Msk            (0x1ul << CRPT_INTSTS_RSAIF_Pos)                  /*!< CRPT INTSTS: RSAIF Mask                */

#define CRPT_INTSTS_RSAEIF_Pos           (31)                                              /*!< CRPT INTSTS: RSAEIF Position           */
#define CRPT_INTSTS_RSAEIF_Msk           (0x1ul << CRPT_INTSTS_RSAEIF_Pos)                 /*!< CRPT INTSTS: RSAEIF Mask               */
...
#define CRPT_HMAC_CTL_HMACEN_Pos         (11)                                               /*!< CRPT_T::HMAC_CTL: OPMODE Position      */
#define CRPT_HMAC_CTL_HMACEN_Msk         (0x1ul << CRPT_HMAC_CTL_HMACEN_Pos)               /*!< CRPT_T::HMAC_CTL: OPMODE Mask          */
...
#define CRPT_ECC_CTL_ECDSAS_Pos          (4)                                               /*!< CRYPTO_T::ECC_CTL: ECDSAS Position     */
#define CRPT_ECC_CTL_ECDSAS_Msk          (0x1ul << CRYPTO_ECC_CTL_ECDSAS_Pos)              /*!< CRYPTO_T::ECC_CTL: ECDSAS Mask         */

#define CRPT_ECC_CTL_ECDSAR_Pos          (5)                                               /*!< CRYPTO_T::ECC_CTL: ECDSAR Position     */
#define CRPT_ECC_CTL_ECDSAR_Msk          (0x1ul << CRYPTO_ECC_CTL_ECDSAR_Pos)              /*!< CRYPTO_T::ECC_CTL: ECDSAR Mask         */
...
#define CRPT_RSA_CTL_CRT_Pos             (2)                                               /*!< CRPT RSA_CTL: CRT Position              */
#define CRPT_RSA_CTL_CRT_Msk             (0x1ul << CRPT_RSA_CTL_CRT_Pos)                   /*!< CRPT RSA_CTL: CRT Mask                  */

#define CRPT_RSA_CTL_CRTBYP_Pos          (3)                                               /*!< CRPT RSA_CTL: CRTBYP Position           */
#define CRPT_RSA_CTL_CRTBYP_Msk          (0x1ul << CRPT_RSA_CTL_CRTBYP_Pos)                /*!< CRPT RSA_CTL: CRTBYP Mask               */

#define CRPT_RSA_CTL_KEYLENG_Pos         (4)                                               /*!< CRPT RSA_CTL: KEYLENG Position           */
#define CRPT_RSA_CTL_KEYLENG_Msk         (0x3ul << CRPT_RSA_CTL_KEYLENG_Pos)                /*!< CRPT RSA_CTL: KEYLENG Mask               */
...
#define CRPT_RSA_STS_CTLERR_Pos          (17)                                              /*!< CRYPTO_T::RSA_STS: CTLERR Position     */
#define CRPT_RSA_STS_CTLERR_Msk          (0x1ul << CRYPTO_RSA_STS_CTLERR_Pos)              /*!< CRYPTO_T::RSA_STS: CTLERR Mask         */

#define CRPT_RSA_STS_KSERR_Pos           (18)                                              /*!< CRYPTO_T::RSA_STS: KSERR Position      */
#define CRPT_RSA_STS_KSERR_Msk           (0x1ul << CRYPTO_RSA_STS_KSERR_Pos)               /*!< CRYPTO_T::RSA_STS: KSERR Mask          */

#define CRPT_RSA_SADDR0_SADDR0_Pos       (0)                                               /*!< CRYPTO_T::RSA_SADDR0: SADDR0 Position  */
#define CRPT_RSA_SADDR0_SADDR0_Msk       (0xfffffffful << CRYPTO_RSA_SADDR0_SADDR0_Pos)    /*!< CRYPTO_T::RSA_SADDR0: SADDR0 Mask      */

#define CRPT_RSA_SADDR1_SADDR1_Pos       (0)                                               /*!< CRYPTO_T::RSA_SADDR1: SADDR1 Position  */
#define CRPT_RSA_SADDR1_SADDR1_Msk       (0xfffffffful << CRYPTO_RSA_SADDR1_SADDR1_Pos)    /*!< CRYPTO_T::RSA_SADDR1: SADDR1 Mask      */

#define CRPT_RSA_SADDR2_SADDR2_Pos       (0)                                               /*!< CRYPTO_T::RSA_SADDR2: SADDR2 Position  */
#define CRPT_RSA_SADDR2_SADDR2_Msk       (0xfffffffful << CRYPTO_RSA_SADDR2_SADDR2_Pos)    /*!< CRYPTO_T::RSA_SADDR2: SADDR2 Mask      */

#define CRPT_RSA_SADDR3_SADDR3_Pos       (0)                                               /*!< CRYPTO_T::RSA_SADDR3: SADDR3 Position  */
#define CRPT_RSA_SADDR3_SADDR3_Msk       (0xfffffffful << CRYPTO_RSA_SADDR3_SADDR3_Pos)    /*!< CRYPTO_T::RSA_SADDR3: SADDR3 Mask      */

#define CRPT_RSA_SADDR4_SADDR4_Pos       (0)                                               /*!< CRYPTO_T::RSA_SADDR4: SADDR4 Position  */
#define CRPT_RSA_SADDR4_SADDR4_Msk       (0xfffffffful << CRYPTO_RSA_SADDR4_SADDR4_Pos)    /*!< CRYPTO_T::RSA_SADDR4: SADDR4 Mask      */

#define CRPT_RSA_DADDR_DADDR_Pos         (0)                                               /*!< CRYPTO_T::RSA_DADDR: DADDR Position    */
#define CRPT_RSA_DADDR_DADDR_Msk         (0xfffffffful << CRYPTO_RSA_DADDR_DADDR_Pos)      /*!< CRYPTO_T::RSA_DADDR: DADDR Mask        */

#define CRPT_RSA_MADDR0_MADDR0_Pos       (0)                                               /*!< CRYPTO_T::RSA_MADDR0: MADDR0 Position  */
#define CRPT_RSA_MADDR0_MADDR0_Msk       (0xfffffffful << CRYPTO_RSA_MADDR0_MADDR0_Pos)    /*!< CRYPTO_T::RSA_MADDR0: MADDR0 Mask      */

#define CRPT_RSA_MADDR1_MADDR1_Pos       (0)                                               /*!< CRYPTO_T::RSA_MADDR1: MADDR1 Position  */
#define CRPT_RSA_MADDR1_MADDR1_Msk       (0xfffffffful << CRYPTO_RSA_MADDR1_MADDR1_Pos)    /*!< CRYPTO_T::RSA_MADDR1: MADDR1 Mask      */

#define CRPT_RSA_MADDR2_MADDR2_Pos       (0)                                               /*!< CRYPTO_T::RSA_MADDR2: MADDR2 Position  */
#define CRPT_RSA_MADDR2_MADDR2_Msk       (0xfffffffful << CRYPTO_RSA_MADDR2_MADDR2_Pos)    /*!< CRYPTO_T::RSA_MADDR2: MADDR2 Mask      */

#define CRPT_RSA_MADDR3_MADDR3_Pos       (0)                                               /*!< CRYPTO_T::RSA_MADDR3: MADDR3 Position  */
#define CRPT_RSA_MADDR3_MADDR3_Msk       (0xfffffffful << CRYPTO_RSA_MADDR3_MADDR3_Pos)    /*!< CRYPTO_T::RSA_MADDR3: MADDR3 Mask      */

#define CRPT_RSA_MADDR4_MADDR4_Pos       (0)                                               /*!< CRYPTO_T::RSA_MADDR4: MADDR4 Position  */
#define CRPT_RSA_MADDR4_MADDR4_Msk       (0xfffffffful << CRYPTO_RSA_MADDR4_MADDR4_Pos)    /*!< CRYPTO_T::RSA_MADDR4: MADDR4 Mask      */

#define CRPT_RSA_MADDR5_MADDR5_Pos       (0)                                               /*!< CRYPTO_T::RSA_MADDR5: MADDR5 Position  */
#define CRPT_RSA_MADDR5_MADDR5_Msk       (0xfffffffful << CRYPTO_RSA_MADDR5_MADDR5_Pos)    /*!< CRYPTO_T::RSA_MADDR5: MADDR5 Mask      */

#define CRPT_RSA_MADDR6_MADDR6_Pos       (0)                                               /*!< CRYPTO_T::RSA_MADDR6: MADDR6 Position  */
#define CRPT_RSA_MADDR6_MADDR6_Msk       (0xfffffffful << CRYPTO_RSA_MADDR6_MADDR6_Pos)    /*!< CRYPTO_T::RSA_MADDR6: MADDR6 Mask      */

#define CRPT_PRNG_KSCTL_NUM_Pos        (0)                                               /*!< CRYPTO_T::PRNG_KSCTL: NUM Position     */
#define CRPT_PRNG_KSCTL_NUM_Msk        (0x1ful << CRPT_PRNG_KSCTL_NUM_Pos)             /*!< CRYPTO_T::PRNG_KSCTL: NUM Mask         */

#define CRPT_PRNG_KSCTL_TRUST_Pos      (16)                                              /*!< CRYPTO_T::PRNG_KSCTL: TRUST Position   */
#define CRPT_PRNG_KSCTL_TRUST_Msk      (0x1ul << CRPT_PRNG_KSCTL_TRUST_Pos)            /*!< CRYPTO_T::PRNG_KSCTL: TRUST Mask       */

#define CRPT_PRNG_KSCTL_PRIV_Pos       (18)                                              /*!< CRYPTO_T::PRNG_KSCTL: PRIV Position    */
#define CRPT_PRNG_KSCTL_PRIV_Msk       (0x1ul << CRPT_PRNG_KSCTL_PRIV_Pos)             /*!< CRYPTO_T::PRNG_KSCTL: PRIV Mask        */

#define CRPT_PRNG_KSCTL_ECDH_Pos       (19)                                              /*!< CRYPTO_T::PRNG_KSCTL: ECDH Position    */
#define CRPT_PRNG_KSCTL_ECDH_Msk       (0x1ul << CRPT_PRNG_KSCTL_ECDH_Pos)             /*!< CRYPTO_T::PRNG_KSCTL: ECDH Mask        */

#define CRPT_PRNG_KSCTL_ECDSA_Pos      (20)                                              /*!< CRYPTO_T::PRNG_KSCTL: ECDSA Position   */
#define CRPT_PRNG_KSCTL_ECDSA_Msk      (0x1ul << CRPT_PRNG_KSCTL_ECDSA_Pos)            /*!< CRYPTO_T::PRNG_KSCTL: ECDSA Mask       */

#define CRPT_PRNG_KSCTL_WDST_Pos       (21)                                              /*!< CRYPTO_T::PRNG_KSCTL: WDST Position    */
#define CRPT_PRNG_KSCTL_WDST_Msk       (0x1ul << CRPT_PRNG_KSCTL_WDST_Pos)             /*!< CRYPTO_T::PRNG_KSCTL: WDST Mask        */

#define CRPT_PRNG_KSCTL_WSDST_Pos      (22)                                              /*!< CRYPTO_T::PRNG_KSCTL: WSDST Position   */
#define CRPT_PRNG_KSCTL_WSDST_Msk      (0x3ul << CRPT_PRNG_KSCTL_WSDST_Pos)            /*!< CRYPTO_T::PRNG_KSCTL: WSDST Mask       */

#define CRPT_PRNG_KSCTL_OWNER_Pos      (24)                                              /*!< CRYPTO_T::PRNG_KSCTL: OWNER Position   */
#define CRPT_PRNG_KSCTL_OWNER_Msk      (0x7ul << CRPT_PRNG_KSCTL_OWNER_Pos)            /*!< CRYPTO_T::PRNG_KSCTL: OWNER Mask       */

#define CRPT_PRNG_KSSTS_NUM_Pos        (0)                                               /*!< CRYPTO_T::PRNG_KSSTS: NUM Position     */
#define CRPT_PRNG_KSSTS_NUM_Msk        (0x1ful << CRPT_PRNG_KSSTS_NUM_Pos)             /*!< CRYPTO_T::PRNG_KSSTS: NUM Mask         */

#define CRPT_PRNG_KSSTS_KCTLERR_Pos    (16)                                              /*!< CRYPTO_T::PRNG_KSSTS: KCTLERR Position */
#define CRPT_PRNG_KSSTS_KCTLERR_Msk    (0x1ul << CRPT_PRNG_KSSTS_KCTLERR_Pos)          /*!< CRYPTO_T::PRNG_KSSTS: KCTLERR Mask     */

#define CRPT_AES_KSCTL_NUM_Pos         (0)                                               /*!< CRYPTO_T::AES_KSCTL: NUM Position      */
#define CRPT_AES_KSCTL_NUM_Msk         (0x1ful << CRPT_AES_KSCTL_NUM_Pos)              /*!< CRYPTO_T::AES_KSCTL: NUM Mask          */

#define CRPT_AES_KSCTL_RSRC_Pos        (5)                                               /*!< CRYPTO_T::AES_KSCTL: RSRC Position     */
#define CRPT_AES_KSCTL_RSRC_Msk        (0x1ul << CRPT_AES_KSCTL_RSRC_Pos)              /*!< CRYPTO_T::AES_KSCTL: RSRC Mask         */

#define CRPT_AES_KSCTL_RSSRC_Pos       (6)                                               /*!< CRYPTO_T::AES_KSCTL: RSSRC Position    */
#define CRPT_AES_KSCTL_RSSRC_Msk       (0x3ul << CRPT_AES_KSCTL_RSSRC_Pos)             /*!< CRYPTO_T::AES_KSCTL: RSSRC Mask        */

#define CRPT_HMAC_KSCTL_NUM_Pos        (0)                                               /*!< CRYPTO_T::HMAC_KSCTL: NUM Position     */
#define CRPT_HMAC_KSCTL_NUM_Msk        (0x1ful << CRPT_HMAC_KSCTL_NUM_Pos)             /*!< CRYPTO_T::HMAC_KSCTL: NUM Mask         */

#define CRPT_HMAC_KSCTL_RSRC_Pos       (5)                                               /*!< CRYPTO_T::HMAC_KSCTL: RSRC Position    */
#define CRPT_HMAC_KSCTL_RSRC_Msk       (0x1ul << CRPT_HMAC_KSCTL_RSRC_Pos)             /*!< CRYPTO_T::HMAC_KSCTL: RSRC Mask        */

#define CRPT_HMAC_KSCTL_RSSRC_Pos      (6)                                               /*!< CRYPTO_T::HMAC_KSCTL: RSSRC Position   */
#define CRPT_HMAC_KSCTL_RSSRC_Msk      (0x3ul << CRPT_HMAC_KSCTL_RSSRC_Pos)            /*!< CRYPTO_T::HMAC_KSCTL: RSSRC Mask       */

#define CRPT_ECC_KSCTL_NUMK_Pos        (0)                                               /*!< CRYPTO_T::ECC_KSCTL: NUMK Position     */
#define CRPT_ECC_KSCTL_NUMK_Msk        (0x1ful << CRPT_ECC_KSCTL_NUMK_Pos)             /*!< CRYPTO_T::ECC_KSCTL: NUMK Mask         */

#define CRPT_ECC_KSCTL_RSRCK_Pos       (5)                                               /*!< CRYPTO_T::ECC_KSCTL: RSRCK Position    */
#define CRPT_ECC_KSCTL_RSRCK_Msk       (0x1ul << CRPT_ECC_KSCTL_RSRCK_Pos)             /*!< CRYPTO_T::ECC_KSCTL: RSRCK Mask        */

#define CRPT_ECC_KSCTL_RSSRCK_Pos      (6)                                               /*!< CRYPTO_T::ECC_KSCTL: RSSRCK Position   */
#define CRPT_ECC_KSCTL_RSSRCK_Msk      (0x3ul << CRPT_ECC_KSCTL_RSSRCK_Pos)            /*!< CRYPTO_T::ECC_KSCTL: RSSRCK Mask       */

#define CRPT_ECC_KSCTL_ECDH_Pos        (14)                                              /*!< CRYPTO_T::ECC_KSCTL: ECDH Position     */
#define CRPT_ECC_KSCTL_ECDH_Msk        (0x1ul << CRPT_ECC_KSCTL_ECDH_Pos)              /*!< CRYPTO_T::ECC_KSCTL: ECDH Mask         */

#define CRPT_ECC_KSCTL_TRUST_Pos       (16)                                              /*!< CRYPTO_T::ECC_KSCTL: TRUST Position    */
#define CRPT_ECC_KSCTL_TRUST_Msk       (0x1ul << CRPT_ECC_KSCTL_TRUST_Pos)             /*!< CRYPTO_T::ECC_KSCTL: TRUST Mask        */

#define CRPT_ECC_KSCTL_PRIV_Pos        (18)                                              /*!< CRYPTO_T::ECC_KSCTL: PRIV Position     */
#define CRPT_ECC_KSCTL_PRIV_Msk        (0x1ul << CRPT_ECC_KSCTL_PRIV_Pos)              /*!< CRYPTO_T::ECC_KSCTL: PRIV Mask         */

#define CRPT_ECC_KSCTL_XY_Pos          (20)                                              /*!< CRYPTO_T::ECC_KSCTL: XY Position       */
#define CRPT_ECC_KSCTL_XY_Msk          (0x1ul << CRPT_ECC_KSCTL_XY_Pos)                /*!< CRYPTO_T::ECC_KSCTL: XY Mask           */

#define CRPT_ECC_KSCTL_WDST_Pos        (21)                                              /*!< CRYPTO_T::ECC_KSCTL: WDST Position     */
#define CRPT_ECC_KSCTL_WDST_Msk        (0x1ul << CRPT_ECC_KSCTL_WDST_Pos)              /*!< CRYPTO_T::ECC_KSCTL: WDST Mask         */

#define CRPT_ECC_KSCTL_WSDST_Pos       (22)                                              /*!< CRYPTO_T::ECC_KSCTL: WSDST Position    */
#define CRPT_ECC_KSCTL_WSDST_Msk       (0x3ul << CRPT_ECC_KSCTL_WSDST_Pos)             /*!< CRYPTO_T::ECC_KSCTL: WSDST Mask        */

#define CRPT_ECC_KSCTL_OWNER_Pos       (24)                                              /*!< CRYPTO_T::ECC_KSCTL: OWNER Position    */
#define CRPT_ECC_KSCTL_OWNER_Msk       (0x7ul << CRPT_ECC_KSCTL_OWNER_Pos)             /*!< CRYPTO_T::ECC_KSCTL: OWNER Mask        */

#define CRPT_ECC_KSSTS_NUM_Pos         (0)                                               /*!< CRYPTO_T::ECC_KSSTS: NUM Position      */
#define CRPT_ECC_KSSTS_NUM_Msk         (0x1ful << CRPT_ECC_KSSTS_NUM_Pos)              /*!< CRYPTO_T::ECC_KSSTS: NUM Mask          */

#define CRPT_ECC_KSXY_NUMX_Pos         (0)                                               /*!< CRYPTO_T::ECC_KSXY: NUMX Position      */
#define CRPT_ECC_KSXY_NUMX_Msk         (0x1ful << CRPT_ECC_KSXY_NUMX_Pos)              /*!< CRYPTO_T::ECC_KSXY: NUMX Mask          */

#define CRPT_ECC_KSXY_RSRCXY_Pos       (5)                                               /*!< CRYPTO_T::ECC_KSXY: RSRCXY Position    */
#define CRPT_ECC_KSXY_RSRCXY_Msk       (0x1ul << CRPT_ECC_KSXY_RSRCXY_Pos)             /*!< CRYPTO_T::ECC_KSXY: RSRCXY Mask        */

#define CRPT_ECC_KSXY_RSSRCX_Pos       (6)                                               /*!< CRYPTO_T::ECC_KSXY: RSSRCX Position    */
#define CRPT_ECC_KSXY_RSSRCX_Msk       (0x3ul << CRPT_ECC_KSXY_RSSRCX_Pos)             /*!< CRYPTO_T::ECC_KSXY: RSSRCX Mask        */

#define CRPT_ECC_KSXY_NUMY_Pos         (8)                                               /*!< CRYPTO_T::ECC_KSXY: NUMY Position      */
#define CRPT_ECC_KSXY_NUMY_Msk         (0x1ful << CRPT_ECC_KSXY_NUMY_Pos)              /*!< CRYPTO_T::ECC_KSXY: NUMY Mask          */

#define CRPT_ECC_KSXY_RSSRCY_Pos       (14)                                              /*!< CRYPTO_T::ECC_KSXY: RSSRCY Position    */
#define CRPT_ECC_KSXY_RSSRCY_Msk       (0x3ul << CRPT_ECC_KSXY_RSSRCY_Pos)             /*!< CRYPTO_T::ECC_KSXY: RSSRCY Mask        */

#define CRPT_RSA_KSCTL_NUM_Pos         (0)                                               /*!< CRYPTO_T::RSA_KSCTL: NUM Position      */
#define CRPT_RSA_KSCTL_NUM_Msk         (0x1ful << CRPT_RSA_KSCTL_NUM_Pos)              /*!< CRYPTO_T::RSA_KSCTL: NUM Mask          */

#define CRPT_RSA_KSCTL_RSRC_Pos        (5)                                               /*!< CRYPTO_T::RSA_KSCTL: RSRC Position     */
#define CRPT_RSA_KSCTL_RSRC_Msk        (0x1ul << CRPT_RSA_KSCTL_RSRC_Pos)              /*!< CRYPTO_T::RSA_KSCTL: RSRC Mask         */

#define CRPT_RSA_KSCTL_RSSRC_Pos       (6)                                               /*!< CRYPTO_T::RSA_KSCTL: RSSRC Position    */
#define CRPT_RSA_KSCTL_RSSRC_Msk       (0x3ul << CRPT_RSA_KSCTL_RSSRC_Pos)             /*!< CRYPTO_T::RSA_KSCTL: RSSRC Mask        */

#define CRPT_RSA_KSCTL_BKNUM_Pos       (8)                                               /*!< CRYPTO_T::RSA_KSCTL: BKNUM Position    */
#define CRPT_RSA_KSCTL_BKNUM_Msk       (0x1ful << CRPT_RSA_KSCTL_BKNUM_Pos)            /*!< CRYPTO_T::RSA_KSCTL: BKNUM Mask        */

#define CRPT_RSA_KSSTS0_NUM0_Pos       (0)                                               /*!< CRYPTO_T::RSA_KSSTS0: NUM0 Position    */
#define CRPT_RSA_KSSTS0_NUM0_Msk       (0x1ful << CRPT_RSA_KSSTS0_NUM0_Pos)            /*!< CRYPTO_T::RSA_KSSTS0: NUM0 Mask        */

#define CRPT_RSA_KSSTS0_NUM1_Pos       (8)                                               /*!< CRYPTO_T::RSA_KSSTS0: NUM1 Position    */
#define CRPT_RSA_KSSTS0_NUM1_Msk       (0x1ful << CRPT_RSA_KSSTS0_NUM1_Pos)            /*!< CRYPTO_T::RSA_KSSTS0: NUM1 Mask        */

#define CRPT_RSA_KSSTS0_NUM2_Pos       (16)                                              /*!< CRYPTO_T::RSA_KSSTS0: NUM2 Position    */
#define CRPT_RSA_KSSTS0_NUM2_Msk       (0x1ful << CRPT_RSA_KSSTS0_NUM2_Pos)            /*!< CRYPTO_T::RSA_KSSTS0: NUM2 Mask        */

#define CRPT_RSA_KSSTS0_NUM3_Pos       (24)                                              /*!< CRYPTO_T::RSA_KSSTS0: NUM3 Position    */
#define CRPT_RSA_KSSTS0_NUM3_Msk       (0x1ful << CRPT_RSA_KSSTS0_NUM3_Pos)            /*!< CRYPTO_T::RSA_KSSTS0: NUM3 Mask        */

#define CRPT_RSA_KSSTS1_NUM4_Pos       (0)                                               /*!< CRYPTO_T::RSA_KSSTS1: NUM4 Position    */
#define CRPT_RSA_KSSTS1_NUM4_Msk       (0x1ful << CRPT_RSA_KSSTS1_NUM4_Pos)            /*!< CRYPTO_T::RSA_KSSTS1: NUM4 Mask        */

#define CRPT_RSA_KSSTS1_NUM5_Pos       (8)                                               /*!< CRYPTO_T::RSA_KSSTS1: NUM5 Position    */
#define CRPT_RSA_KSSTS1_NUM5_Msk       (0x1ful << CRPT_RSA_KSSTS1_NUM5_Pos)            /*!< CRYPTO_T::RSA_KSSTS1: NUM5 Mask        */

#define CRPT_RSA_KSSTS1_NUM6_Pos       (16)                                              /*!< CRYPTO_T::RSA_KSSTS1: NUM6 Position    */
#define CRPT_RSA_KSSTS1_NUM6_Msk       (0x1ful << CRPT_RSA_KSSTS1_NUM6_Pos)            /*!< CRYPTO_T::RSA_KSSTS1: NUM6 Mask        */

#define CRPT_RSA_KSSTS1_NUM7_Pos       (24)                                              /*!< CRYPTO_T::RSA_KSSTS1: NUM7 Position    */
#define CRPT_RSA_KSSTS1_NUM7_Msk       (0x1ful << CRPT_RSA_KSSTS1_NUM7_Pos)            /*!< CRYPTO_T::RSA_KSSTS1: NUM7 Mask        */
