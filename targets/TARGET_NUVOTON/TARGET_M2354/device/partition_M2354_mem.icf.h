...
define symbol NU_ROM_SIZE_S             = (0x100000 - MBED_ROM_SIZE);
/* Resolved secure RAM layout */
define symbol NU_RAM_START_S            = 0x20000000;
define symbol NU_RAM_SIZE_S             = (0x40000 - MBED_RAM_SIZE);
...
define symbol NU_ROM_SIZE_NS            = (0x100000 - MBED_ROM_SIZE);
/* Resolved non-secure RAM layout */
define symbol NU_RAM_START_NS           = (0x30000000 + MBED_RAM_SIZE);
define symbol NU_RAM_SIZE_NS            = (0x40000 - MBED_RAM_SIZE);
