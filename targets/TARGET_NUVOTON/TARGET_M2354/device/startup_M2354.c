...
WEAK_ALIAS_FUNC(RTC_TAMPER_IRQHandler, Default_Handler) // 7: RTC Tamper detection
...
WEAK_ALIAS_FUNC(TRNG_IRQHandler, Default_Handler)       // 101: TRNG
                                                        // 102~108: Reserved
WEAK_ALIAS_FUNC(KS_IRQHandler, Default_Handler)         // 109
WEAK_ALIAS_FUNC(TAMPER_IRQHandler, Default_Handler)     // 110
...
const uint32_t __vector_handlers[] = {
    ...
    (uint32_t) RTC_TAMPER_IRQHandler,   // 7: RTC Tamper detection
    ...
    (uint32_t) Default_Handler,         // 102:
    (uint32_t) Default_Handler,         // 103:
    (uint32_t) Default_Handler,         // 104:
    (uint32_t) Default_Handler,         // 105:
    (uint32_t) Default_Handler,         // 106:
    (uint32_t) Default_Handler,         // 107:
    (uint32_t) Default_Handler,         // 108:
    (uint32_t) KS_IRQHandler,           // 109:
    (uint32_t) TAMPER_IRQHandler,       // 110:
