...
static void uart8_vec(void);
static void uart9_vec(void);
...
static void uart8_vec_async(void);
static void uart9_vec_async(void);
...
static const struct nu_modinit_s uart_modinit_tab[] = {
    ...
    {UART_8, UART8_MODULE, CLK_CLKSEL2_UART8SEL_HIRC, CLK_CLKDIV5_UART8(1), UART8_RST, UART8_IRQn, &uart8_var},
    {UART_9, UART9_MODULE, CLK_CLKSEL2_UART9SEL_HIRC, CLK_CLKDIV5_UART9(1), UART9_RST, UART9_IRQn, &uart9_var},
...
static void uart8_vec(void)
{
    uart_irq(uart8_var.obj);
}

static void uart9_vec(void)
{
    uart_irq(uart9_var.obj);
}
...
static void uart8_vec_async(void)
{
    uart_irq_async(uart8_var.obj);
}

static void uart9_vec_async(void)
{
    uart_irq_async(uart9_var.obj);
}
