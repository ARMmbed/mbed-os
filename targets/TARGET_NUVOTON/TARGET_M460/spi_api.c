...
static const struct nu_modinit_s spi_modinit_tab[] = {
    ...
    {SPI_2, SPI2_MODULE, CLK_CLKSEL3_SPI2SEL_PCLK1, MODULE_NoMsk, SPI2_RST, SPI2_IRQn, &spi2_var},
    {SPI_3, SPI3_MODULE, CLK_CLKSEL3_SPI3SEL_PCLK0, MODULE_NoMsk, SPI3_RST, SPI3_IRQn, &spi3_var},
    {SPI_4, SPI4_MODULE, CLK_CLKSEL4_SPI4SEL_PCLK1, MODULE_NoMsk, SPI4_RST, SPI4_IRQn, &spi4_var},
    {SPI_5, SPI5_MODULE, CLK_CLKSEL4_SPI5SEL_PCLK0, MODULE_NoMsk, SPI5_RST, SPI5_IRQn, &spi5_var},
    {SPI_6, SPI6_MODULE, CLK_CLKSEL4_SPI6SEL_PCLK1, MODULE_NoMsk, SPI6_RST, SPI6_IRQn, &spi6_var},
    {SPI_7, SPI7_MODULE, CLK_CLKSEL4_SPI7SEL_PCLK0, MODULE_NoMsk, SPI7_RST, SPI7_IRQn, &spi7_var},
    {SPI_8, SPI8_MODULE, CLK_CLKSEL4_SPI8SEL_PCLK1, MODULE_NoMsk, SPI8_RST, SPI8_IRQn, &spi8_var},
    {SPI_9, SPI9_MODULE, CLK_CLKSEL4_SPI9SEL_PCLK0, MODULE_NoMsk, SPI9_RST, SPI9_IRQn, &spi9_var},
    {SPI_10, SPI10_MODULE, CLK_CLKSEL4_SPI10SEL_PCLK1, MODULE_NoMsk, SPI10_RST, SPI10_IRQn, &spi10_var},
    /* Degrade QSPI0/1 to SPI_11/12 for standard SPI usage */
    {SPI_11, QSPI0_MODULE, CLK_CLKSEL2_QSPI0SEL_PCLK0, MODULE_NoMsk, QSPI0_RST, QSPI0_IRQn, &spi11_var},
    {SPI_12, QSPI1_MODULE, CLK_CLKSEL2_QSPI1SEL_PCLK1, MODULE_NoMsk, QSPI1_RST, QSPI1_IRQn, &spi12_var},
