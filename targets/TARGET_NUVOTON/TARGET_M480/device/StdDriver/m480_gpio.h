...
#define PG0             GPIO_PIN_DATA(6, 0 ) /*!< Specify PG.0 Pin Data Input/Output */
...
#define PG6             GPIO_PIN_DATA(6, 6 ) /*!< Specify PG.6 Pin Data Input/Output */
...
#define PH0             GPIO_PIN_DATA(7, 0 ) /*!< Specify PH.0 Pin Data Input/Output */
#define PH1             GPIO_PIN_DATA(7, 1 ) /*!< Specify PH.1 Pin Data Input/Output */
#define PH2             GPIO_PIN_DATA(7, 2 ) /*!< Specify PH.2 Pin Data Input/Output */
#define PH3             GPIO_PIN_DATA(7, 3 ) /*!< Specify PH.3 Pin Data Input/Output */
...
#define PH12            GPIO_PIN_DATA(7, 12) /*!< Specify PH.12 Pin Data Input/Output */
#define PH13            GPIO_PIN_DATA(7, 13) /*!< Specify PH.13 Pin Data Input/Output */
#define PH14            GPIO_PIN_DATA(7, 14) /*!< Specify PH.14 Pin Data Input/Output */
#define PH15            GPIO_PIN_DATA(7, 15) /*!< Specify PH.15 Pin Data Input/Output */
