...
#define LP_TICKER_AM_HAL_CTIMER_SEGMENT AM_HAL_CTIMER_TIMERA
#define LP_TICKER_AM_HAL_CTIMER_NUMBER 7
#define LP_TICKER_AM_HAL_CTIMER_FN AM_HAL_CTIMER_FN_CONTINUOUS
#define LP_TICKER_AM_HAL_CTIMER_CMPR_REG 0 // CMPR0 reg used with CTIMER_FN_CONTINUOUS mode
#define LP_TICKER_AM_HAL_CTIMER_CMPR_INT AM_HAL_CTIMER_INT_TIMERA7C0
