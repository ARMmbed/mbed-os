...
/**  */
#define AUX_DIGIF_APB_MMAP_AFC_DAC_AFC_DAC_DISABLE_TO_MID_FORCED_TO_GROUND_VALUE 0
/**  */
#define AUX_DIGIF_APB_MMAP_AFC_DAC_AFC_DAC_DISABLE_TO_MID_FORCED_TO_MIDRAIL_VALUE 1
