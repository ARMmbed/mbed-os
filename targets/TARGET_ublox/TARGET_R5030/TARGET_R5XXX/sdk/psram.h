...
struct psram_s {
   ...
   /** PHY TX DLL Master Control Register at address offset 0x408, read-write */
   uint32_t phy_tx_dll_master_control;
   /** PHY RX DLL Master Control Register at address offset 0x40C, read-write */
   uint32_t phy_rx_dll_master_control;
   /** PHY TX DLL Observable Register (Master DLL) at address offset 0x410, read-only */
   uint32_t phy_tx_dll_obs_reg_master;
   /** PHY TX DLL Observable Register (Slave DLL) at address offset 0x414, read-only */
   uint32_t phy_tx_dll_obs_reg_slave;
   /** PHY RX DLL Observable Register (Master DLL) at address offset 0x418, read-only */
   uint32_t phy_rx_dll_obs_reg_master;
   /** PHY RX DLL Observable Register (Slave DLL) at address offset 0x41C, read-only */
...
#define PSRAM_RCR_RESERVED_RCR_1_SIZE 5
#define PSRAM_RCR_AP_ADVANCED_ID_OFFSET 12
#define PSRAM_RCR_AP_ADVANCED_ID_SIZE 1
#define PSRAM_RCR_RESERVED_RCR_2_OFFSET 13
#define PSRAM_RCR_RESERVED_RCR_2_SIZE 2
#define PSRAM_RCR_SORT_REJECT_OFFSET 15
#define PSRAM_RCR_SORT_REJECT_SIZE 1
...
#define PSRAM_PHY_TX_DLL_CONFIGURATION_PHY_TX_DLL_CONFIG_RESET_OFFSET 30
#define PSRAM_PHY_TX_DLL_CONFIGURATION_PHY_TX_DLL_CONFIG_RESET_SIZE 1
...
#define PSRAM_PHY_RX_DLL_CONFIGURATION_PHY_RX_DLL_CONFIG_SLAVE_MEMCLK_DELAY_OFFSET 0
#define PSRAM_PHY_RX_DLL_CONFIGURATION_PHY_RX_DLL_CONFIG_SLAVE_MEMCLK_DELAY_SIZE 7
...
#define PSRAM_PHY_RX_DLL_CONFIGURATION_PHY_RX_DLL_CONFIG_SLAVE_UDQS_DELAY_OFFSET 16
...
#define PSRAM_PHY_RX_DLL_CONFIGURATION_PHY_RX_DLL_CONFIG_SLAVE_MEMCLK_BYPASS_OFFSET 27
#define PSRAM_PHY_RX_DLL_CONFIGURATION_PHY_RX_DLL_CONFIG_SLAVE_MEMCLK_BYPASS_SIZE 1
...
#define PSRAM_PHY_RX_DLL_CONFIGURATION_PHY_RX_DLL_CONFIG_RESET_OFFSET 30
#define PSRAM_PHY_RX_DLL_CONFIGURATION_PHY_RX_DLL_CONFIG_RESET_SIZE 1
...
/** bit field defines for psram_s#phy_tx_dll_master_control */
#define PSRAM_PHY_TX_DLL_MASTER_CONTROL_PHY_TX_DLL_MASTER_INITIAL_DELAY_OFFSET 0
#define PSRAM_PHY_TX_DLL_MASTER_CONTROL_PHY_TX_DLL_MASTER_INITIAL_DELAY_SIZE 7
#define PSRAM_PHY_TX_DLL_MASTER_CONTROL_PHY_TX_DLL_MASTER_NB_INDICATIONS_OFFSET 16
#define PSRAM_PHY_TX_DLL_MASTER_CONTROL_PHY_TX_DLL_MASTER_NB_INDICATIONS_SIZE 3
#define PSRAM_PHY_TX_DLL_MASTER_CONTROL_PHY_TX_DLL_MASTER_PHASE_DETECT_SELECTOR_OFFSET 20
#define PSRAM_PHY_TX_DLL_MASTER_CONTROL_PHY_TX_DLL_MASTER_PHASE_DETECT_SELECTOR_SIZE 3
#define PSRAM_PHY_TX_DLL_MASTER_CONTROL_PHY_TX_DLL_MASTER_BYPASS_MODE_OFFSET 23
#define PSRAM_PHY_TX_DLL_MASTER_CONTROL_PHY_TX_DLL_MASTER_BYPASS_MODE_SIZE 1
#define PSRAM_PHY_TX_DLL_MASTER_CONTROL_PHY_TX_DLL_MASTER_LOCK_MODE_OFFSET 24
#define PSRAM_PHY_TX_DLL_MASTER_CONTROL_PHY_TX_DLL_MASTER_LOCK_MODE_SIZE 1

/** bit field defines for psram_s#phy_rx_dll_master_control */
#define PSRAM_PHY_RX_DLL_MASTER_CONTROL_PHY_RX_DLL_MASTER_INITIAL_DELAY_OFFSET 0
#define PSRAM_PHY_RX_DLL_MASTER_CONTROL_PHY_RX_DLL_MASTER_INITIAL_DELAY_SIZE 7
#define PSRAM_PHY_RX_DLL_MASTER_CONTROL_PHY_RX_DLL_MASTER_NB_INDICATIONS_OFFSET 16
#define PSRAM_PHY_RX_DLL_MASTER_CONTROL_PHY_RX_DLL_MASTER_NB_INDICATIONS_SIZE 3
#define PSRAM_PHY_RX_DLL_MASTER_CONTROL_PHY_RX_DLL_MASTER_PHASE_DETECT_SELECTOR_OFFSET 20
#define PSRAM_PHY_RX_DLL_MASTER_CONTROL_PHY_RX_DLL_MASTER_PHASE_DETECT_SELECTOR_SIZE 3
#define PSRAM_PHY_RX_DLL_MASTER_CONTROL_PHY_RX_DLL_MASTER_BYPASS_MODE_OFFSET 23
#define PSRAM_PHY_RX_DLL_MASTER_CONTROL_PHY_RX_DLL_MASTER_BYPASS_MODE_SIZE 1
#define PSRAM_PHY_RX_DLL_MASTER_CONTROL_PHY_RX_DLL_MASTER_LOCK_MODE_OFFSET 24
#define PSRAM_PHY_RX_DLL_MASTER_CONTROL_PHY_RX_DLL_MASTER_LOCK_MODE_SIZE 1

/** bit field defines for psram_s#phy_tx_dll_obs_reg_master */
#define PSRAM_PHY_TX_DLL_OBS_REG_MASTER_PHY_TX_DLL_OBSERVABLE_DLL_LOCK_OFFSET 0
#define PSRAM_PHY_TX_DLL_OBS_REG_MASTER_PHY_TX_DLL_OBSERVABLE_DLL_LOCK_SIZE 1
#define PSRAM_PHY_TX_DLL_OBS_REG_MASTER_PHY_TX_DLL_OBSERVABLE_LOCK_MODE_OFFSET 1
#define PSRAM_PHY_TX_DLL_OBS_REG_MASTER_PHY_TX_DLL_OBSERVABLE_LOCK_MODE_SIZE 2
#define PSRAM_PHY_TX_DLL_OBS_REG_MASTER_PHY_TX_DLL_OBSERVABLE_UNLOCK_COUNTER_OFFSET 3
#define PSRAM_PHY_TX_DLL_OBS_REG_MASTER_PHY_TX_DLL_OBSERVABLE_UNLOCK_COUNTER_SIZE 5
#define PSRAM_PHY_TX_DLL_OBS_REG_MASTER_PHY_TX_DLL_OBSERVABLE_LOCK_VALUE_OFFSET 8
#define PSRAM_PHY_TX_DLL_OBS_REG_MASTER_PHY_TX_DLL_OBSERVABLE_LOCK_VALUE_SIZE 7
#define PSRAM_PHY_TX_DLL_OBS_REG_MASTER_PHY_TX_DLL_OBSERVABLE_LOOPBACK_LOCK_OFFSET 15
#define PSRAM_PHY_TX_DLL_OBS_REG_MASTER_PHY_TX_DLL_OBSERVABLE_LOOPBACK_LOCK_SIZE 1
#define PSRAM_PHY_TX_DLL_OBS_REG_MASTER_PHY_TX_DLL_OBSERVABLE_DLL_LOCK_DEC_OFFSET 16
#define PSRAM_PHY_TX_DLL_OBS_REG_MASTER_PHY_TX_DLL_OBSERVABLE_DLL_LOCK_DEC_SIZE 8
#define PSRAM_PHY_TX_DLL_OBS_REG_MASTER_PHY_TX_DLL_OBSERVABLE_DLL_LOCK_INC_OFFSET 24
#define PSRAM_PHY_TX_DLL_OBS_REG_MASTER_PHY_TX_DLL_OBSERVABLE_DLL_LOCK_INC_SIZE 8
...
/** bit field defines for psram_s#phy_rx_dll_obs_reg_master */
#define PSRAM_PHY_RX_DLL_OBS_REG_MASTER_PHY_RX_DLL_OBSERVABLE_DLL_LOCK_OFFSET 0
#define PSRAM_PHY_RX_DLL_OBS_REG_MASTER_PHY_RX_DLL_OBSERVABLE_DLL_LOCK_SIZE 1
#define PSRAM_PHY_RX_DLL_OBS_REG_MASTER_PHY_RX_DLL_OBSERVABLE_LOCK_MODE_OFFSET 1
#define PSRAM_PHY_RX_DLL_OBS_REG_MASTER_PHY_RX_DLL_OBSERVABLE_LOCK_MODE_SIZE 2
#define PSRAM_PHY_RX_DLL_OBS_REG_MASTER_PHY_RX_DLL_OBSERVABLE_UNLOCK_COUNTER_OFFSET 3
#define PSRAM_PHY_RX_DLL_OBS_REG_MASTER_PHY_RX_DLL_OBSERVABLE_UNLOCK_COUNTER_SIZE 5
#define PSRAM_PHY_RX_DLL_OBS_REG_MASTER_PHY_RX_DLL_OBSERVABLE_LOCK_VALUE_OFFSET 8
#define PSRAM_PHY_RX_DLL_OBS_REG_MASTER_PHY_RX_DLL_OBSERVABLE_LOCK_VALUE_SIZE 7
#define PSRAM_PHY_RX_DLL_OBS_REG_MASTER_PHY_RX_DLL_OBSERVABLE_LOOPBACK_LOCK_OFFSET 15
#define PSRAM_PHY_RX_DLL_OBS_REG_MASTER_PHY_RX_DLL_OBSERVABLE_LOOPBACK_LOCK_SIZE 1
#define PSRAM_PHY_RX_DLL_OBS_REG_MASTER_PHY_RX_DLL_OBSERVABLE_DLL_LOCK_DEC_OFFSET 16
#define PSRAM_PHY_RX_DLL_OBS_REG_MASTER_PHY_RX_DLL_OBSERVABLE_DLL_LOCK_DEC_SIZE 8
#define PSRAM_PHY_RX_DLL_OBS_REG_MASTER_PHY_RX_DLL_OBSERVABLE_DLL_LOCK_INC_OFFSET 24
#define PSRAM_PHY_RX_DLL_OBS_REG_MASTER_PHY_RX_DLL_OBSERVABLE_DLL_LOCK_INC_SIZE 8

/** bit field defines for psram_s#phy_rx_dll_obs_reg_slave */
#define PSRAM_PHY_RX_DLL_OBS_REG_SLAVE_PHY_RX_DLL_OBSERVABLE_MEM_CLK_DECODER_OUTPUT_OFFSET 0
#define PSRAM_PHY_RX_DLL_OBS_REG_SLAVE_PHY_RX_DLL_OBSERVABLE_MEM_CLK_DECODER_OUTPUT_SIZE 7
#define PSRAM_PHY_RX_DLL_OBS_REG_SLAVE_PHY_RX_DLL_OBSERVABLE_LDQS_DECODER_OUTPUT_OFFSET 8
#define PSRAM_PHY_RX_DLL_OBS_REG_SLAVE_PHY_RX_DLL_OBSERVABLE_LDQS_DECODER_OUTPUT_SIZE 7
#define PSRAM_PHY_RX_DLL_OBS_REG_SLAVE_PHY_RX_DLL_OBSERVABLE_UDQS_DECODER_OUTPUT_OFFSET 16
