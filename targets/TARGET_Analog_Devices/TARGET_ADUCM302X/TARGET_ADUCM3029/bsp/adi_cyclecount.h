...
/*!
 * Using a 64 bit integer to record cycle counts.               
 * UINT32_MAX = 4,294,967,296 cycles                            
 ...
 */
#define ADI_CYCLE_COUNTING_SYSTICKS        (0xFFFFFFu) 
 ...
 * index (0) 
 */
#define ADI_CYCLE_COUNTING_INITIAL_STACK_INDEX (-1)
...
#define    ADI_CYCLECOUNT_ISR_I2C           7u      /*!< Cycle count ID for I2C Interrupt Handler. */
#define    ADI_CYCLECOUNT_ID_COUNT          8u      /*!< Number of cycle count ISRs and APIs. Must be one greater than the last ID. */
