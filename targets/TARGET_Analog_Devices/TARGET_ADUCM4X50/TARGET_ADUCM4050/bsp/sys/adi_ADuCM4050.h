...
#define REG_RTC0_OC2                         0x40001074            /*  RTC0 RTC Output Compare Channel 2 */
#define REG_RTC0_OC3                         0x40001078            /*  RTC0 RTC Output Compare Channel 3 */
#define REG_RTC0_OC4                         0x4000107C            /*  RTC0 RTC Output Compare Channel 4 */
...
#define REG_RTC0_OC2TGT                      0x40001094            /*  RTC0 RTC Output Compare Channel 2 Target */
#define REG_RTC0_OC3TGT                      0x40001098            /*  RTC0 RTC Output Compare Channel 3 Target */
#define REG_RTC0_OC1LOWDUR                   0x400010A0            /*  RTC0 RTC Auto-Reload Low Duration for Output Compare Channel 1 */
#define REG_RTC0_OC2LOWDUR                   0x400010A4            /*  RTC0 RTC Auto-Reload Low Duration for Output Compare Channel 2 */
#define REG_RTC0_OC3LOWDUR                   0x400010A8            /*  RTC0 RTC Auto-Reload Low Duration for Output Compare Channel 3 */
#define REG_RTC0_OC1HIGHDUR                  0x400010B0            /*  RTC0 RTC Auto-Reload High Duration for Output Compare Channel 1 */
#define REG_RTC0_OC2HIGHDUR                  0x400010B4            /*  RTC0 RTC Auto-Reload High Duration for Output Compare Channel 2 */
#define REG_RTC0_OC3HIGHDUR                  0x400010B8            /*  RTC0 RTC Auto-Reload High Duration for Output Compare Channel 3 */
#define REG_RTC0_OCMSKOT                     0x400010C0            /*  RTC0 RTC Masks for Output Compare Channel */
#define REG_RTC0_CR5OCS                      0x400010C4            /*  RTC0 RTC Control 5 for Configuring Output Compare Channel GPIO Sampling */
#define REG_RTC0_CR6OCS                      0x400010C8            /*  RTC0 RTC Control 5 for Configuring Output Compare Channel GPIO Sampling Edge */
#define REG_RTC0_CR7OCS                      0x400010CC            /*  RTC0 RTC Control 5 for Configuring Output Compare Channel GPIO Sampling Activity */
...
#define REG_RTC1_OC2                         0x40001474            /*  RTC1 RTC Output Compare Channel 2 */
#define REG_RTC1_OC3                         0x40001478            /*  RTC1 RTC Output Compare Channel 3 */
#define REG_RTC1_OC4                         0x4000147C            /*  RTC1 RTC Output Compare Channel 4 */
...
#define REG_RTC1_OC2TGT                      0x40001494            /*  RTC1 RTC Output Compare Channel 2 Target */
#define REG_RTC1_OC3TGT                      0x40001498            /*  RTC1 RTC Output Compare Channel 3 Target */
#define REG_RTC1_OC1LOWDUR                   0x400014A0            /*  RTC1 RTC Auto-Reload Low Duration for Output Compare Channel 1 */
#define REG_RTC1_OC2LOWDUR                   0x400014A4            /*  RTC1 RTC Auto-Reload Low Duration for Output Compare Channel 2 */
#define REG_RTC1_OC3LOWDUR                   0x400014A8            /*  RTC1 RTC Auto-Reload Low Duration for Output Compare Channel 3 */
#define REG_RTC1_OC1HIGHDUR                  0x400014B0            /*  RTC1 RTC Auto-Reload High Duration for Output Compare Channel 1 */
#define REG_RTC1_OC2HIGHDUR                  0x400014B4            /*  RTC1 RTC Auto-Reload High Duration for Output Compare Channel 2 */
#define REG_RTC1_OC3HIGHDUR                  0x400014B8            /*  RTC1 RTC Auto-Reload High Duration for Output Compare Channel 3 */
#define REG_RTC1_OCMSKOT                     0x400014C0            /*  RTC1 RTC Masks for Output Compare Channel */
#define REG_RTC1_CR5OCS                      0x400014C4            /*  RTC1 RTC Control 5 for Configuring Output Compare Channel GPIO Sampling */
#define REG_RTC1_CR6OCS                      0x400014C8            /*  RTC1 RTC Control 5 for Configuring Output Compare Channel GPIO Sampling Edge */
#define REG_RTC1_CR7OCS                      0x400014CC            /*  RTC1 RTC Control 5 for Configuring Output Compare Channel GPIO Sampling Activity */
...
#define ENUM_RTC_CR0_EX_30_TIME_UNITS        (_ADI_MSK_3(0x000003C0,0x000003C0U, uint16_t  ))    /*  MOD60ALM: Example of setting a modulo-60 periodic interrupt from the RTC to be issued to the CPU at 30 time units past a modulo-60 boundary. */
#define ENUM_RTC_CR0_EX_55_TIME_UNITS        (_ADI_MSK_3(0x000006E0,0x000006E0U, uint16_t  ))    /*  MOD60ALM: Example of setting a modulo-60 periodic interrupt from the RTC to be issued to the CPU at 55 time units past a modulo-60 boundary. */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_MOD_CNT0_4TOZERO            11            /*  Mirror of RTC Count 0 Register */
...
#define BITM_RTC_MOD_CNT0_4TOZERO            (_ADI_MSK_3(0x0000F800,0x0000F800U, uint16_t  ))    /*  Mirror of RTC Count 0 Register */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_SR3_ALMINTMIR               13            /*  Read-only mirror of the ALMINT interrupt source in RTC Status 0 Register, acting as RTCOC0IRQ */
#define BITP_RTC_SR3_RTCOC4IRQ               12            /*  Sticky Interrupt Source for the RTCOC4 Output Compare channel */
#define BITP_RTC_SR3_RTCOC3IRQ               11            /*  Sticky Interrupt Source for the RTCOC3 Output Compare channel */
#define BITP_RTC_SR3_RTCOC2IRQ               10            /*  Sticky Interrupt Source for the RTCOC2 Output Compare channel */
#define BITP_RTC_SR3_RTCOC1IRQ                9            /*  Sticky Interrupt Source for Output Compare Channel 1 */
#define BITP_RTC_SR3_RTCOC4FEIRQ              8            /*  Sticky Interrupt Source for the RTCOC4 Output Compare channel falling edge */
#define BITP_RTC_SR3_RTCOC3FEIRQ              7            /*  Sticky Interrupt Source for the RTCOC3 Output Compare channel falling edge */
#define BITP_RTC_SR3_RTCOC2FEIRQ              6            /*  Sticky Interrupt Source for the RTCOC2 Output Compare channel falling edge */
#define BITP_RTC_SR3_RTCOC1FEIRQ              5            /*  Sticky Interrupt Source for Output Compare Channel 1 */
...
#define BITM_RTC_SR3_ALMINTMIR               (_ADI_MSK_3(0x00002000,0x00002000U, uint16_t  ))    /*  Read-only mirror of the ALMINT interrupt source in RTC Status 0 Register, acting as RTCOC0IRQ */

#define BITM_RTC_SR3_RTCOC4IRQ               (_ADI_MSK_3(0x00001000,0x00001000U, uint16_t  ))    /*  Sticky Interrupt Source for the RTCOC4 Output Compare channel */

#define BITM_RTC_SR3_RTCOC3IRQ               (_ADI_MSK_3(0x00000800,0x00000800U, uint16_t  ))    /*  Sticky Interrupt Source for the RTCOC3 Output Compare channel */

#define BITM_RTC_SR3_RTCOC2IRQ               (_ADI_MSK_3(0x00000400,0x00000400U, uint16_t  ))    /*  Sticky Interrupt Source for the RTCOC2 Output Compare channel */
...
#define BITM_RTC_SR3_RTCOC4FEIRQ             (_ADI_MSK_3(0x00000100,0x00000100U, uint16_t  ))    /*  Sticky Interrupt Source for the RTCOC4 Output Compare channel falling edge */

#define BITM_RTC_SR3_RTCOC3FEIRQ             (_ADI_MSK_3(0x00000080,0x00000080U, uint16_t  ))    /*  Sticky Interrupt Source for the RTCOC3 Output Compare channel falling edge */

#define BITM_RTC_SR3_RTCOC2FEIRQ             (_ADI_MSK_3(0x00000040,0x00000040U, uint16_t  ))    /*  Sticky Interrupt Source for the RTCOC2 Output Compare channel falling edge */

#define BITM_RTC_SR3_RTCOC1FEIRQ             (_ADI_MSK_3(0x00000020,0x00000020U, uint16_t  ))    /*  Sticky Interrupt Source for Output Compare Channel 1 */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_CR3OC_RTCOC4IRQEN           12            /*  Posedge EdgeInterrupt Enable for the RTCOC4 Output Compare channel */
#define BITP_RTC_CR3OC_RTCOC3IRQEN           11            /*  Posedge EdgeInterrupt Enable for the RTCOC3 Output Compare channel */
#define BITP_RTC_CR3OC_RTCOC2IRQEN           10            /*  Posedge EdgeInterrupt Enable for the RTCOC2 Output Compare channel */
#define BITP_RTC_CR3OC_RTCOC1IRQEN            9            /*  Interrupt Enable for Output Compare Channel 1 */
#define BITP_RTC_CR3OC_RTCOC4FEIRQEN          8            /*  Falling Edge Interrupt Enable for the RTCOC4 Output Compare channel */
#define BITP_RTC_CR3OC_RTCOC3FEIRQEN          7            /*  Falling Edge Interrupt Enable for the RTCOC3 Output Compare channel */
#define BITP_RTC_CR3OC_RTCOC2FEIRQEN          6            /*  Falling Edge Interrupt Enable for the RTCOC2 Output Compare channel */
#define BITP_RTC_CR3OC_RTCOC1FEIRQEN          5            /*  Falling Edge Interrupt Enable for the RTCOC1 Output Compare channel */
#define BITP_RTC_CR3OC_RTCOC4EN               4            /*  Enable for the RTCOC4 Output Compare channel */
#define BITP_RTC_CR3OC_RTCOC3EN               3            /*  Enable for the RTCOC3 Output Compare channel */
#define BITP_RTC_CR3OC_RTCOC2EN               2            /*  Enable for the RTCOC2 Output Compare channel */
#define BITP_RTC_CR3OC_RTCOC1EN               1            /*  Enable for Output Compare Channel 1 */

#define BITM_RTC_CR3OC_RTCOC4IRQEN           (_ADI_MSK_3(0x00001000,0x00001000U, uint16_t  ))    /*  Posedge EdgeInterrupt Enable for the RTCOC4 Output Compare channel */

#define BITM_RTC_CR3OC_RTCOC3IRQEN           (_ADI_MSK_3(0x00000800,0x00000800U, uint16_t  ))    /*  Posedge EdgeInterrupt Enable for the RTCOC3 Output Compare channel */

#define BITM_RTC_CR3OC_RTCOC2IRQEN           (_ADI_MSK_3(0x00000400,0x00000400U, uint16_t  ))    /*  Posedge EdgeInterrupt Enable for the RTCOC2 Output Compare channel */
...
#define BITM_RTC_CR3OC_RTCOC4FEIRQEN         (_ADI_MSK_3(0x00000100,0x00000100U, uint16_t  ))    /*  Falling Edge Interrupt Enable for the RTCOC4 Output Compare channel */

#define BITM_RTC_CR3OC_RTCOC3FEIRQEN         (_ADI_MSK_3(0x00000080,0x00000080U, uint16_t  ))    /*  Falling Edge Interrupt Enable for the RTCOC3 Output Compare channel */

#define BITM_RTC_CR3OC_RTCOC2FEIRQEN         (_ADI_MSK_3(0x00000040,0x00000040U, uint16_t  ))    /*  Falling Edge Interrupt Enable for the RTCOC2 Output Compare channel */

#define BITM_RTC_CR3OC_RTCOC1FEIRQEN         (_ADI_MSK_3(0x00000020,0x00000020U, uint16_t  ))    /*  Falling Edge Interrupt Enable for the RTCOC1 Output Compare channel */

#define BITM_RTC_CR3OC_RTCOC4EN              (_ADI_MSK_3(0x00000010,0x00000010U, uint16_t  ))    /*  Enable for the RTCOC4 Output Compare channel */

#define BITM_RTC_CR3OC_RTCOC3EN              (_ADI_MSK_3(0x00000008,0x00000008U, uint16_t  ))    /*  Enable for the RTCOC3 Output Compare channel */

#define BITM_RTC_CR3OC_RTCOC2EN              (_ADI_MSK_3(0x00000004,0x00000004U, uint16_t  ))    /*  Enable for the RTCOC2 Output Compare channel */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_CR4OC_RTCOC3ARLEN           11            /*  Enable for fine control on RTCOC3 period and duty cycle. */
#define BITP_RTC_CR4OC_RTCOC2ARLEN           10            /*  Enable for fine control on RTCOC2 period and duty cycle. */
#define BITP_RTC_CR4OC_RTCOC1ARLEN            9            /*  Enable for fine control on RTCOC1 period and duty cycle. */
#define BITP_RTC_CR4OC_RTCOC4POL              8            /*  RTCOC4 Polarity Control */
#define BITP_RTC_CR4OC_RTCOC3POL              7            /*  RTCOC3 Polarity Control */
#define BITP_RTC_CR4OC_RTCOC2POL              6            /*  RTCOC2 Polarity Control */
#define BITP_RTC_CR4OC_RTCOC1POL              5            /*  RTCOC1 Polarity Control */
#define BITP_RTC_CR4OC_RTCOC4MSKEN            4            /*  Enable for thermometer-code masking of the Output Compare 4 channel. */
#define BITP_RTC_CR4OC_RTCOC3MSKEN            3            /*  Enable for thermometer-code masking of the Output Compare 3 channel. */
#define BITP_RTC_CR4OC_RTCOC2MSKEN            2            /*  Enable for thermometer-code masking of the Output Compare 2 channel. */
#define BITP_RTC_CR4OC_RTCOC1MSKEN            1            /*  Enable for thermometer-code masking of the Output Compare 1 Channel */

#define BITM_RTC_CR4OC_RTCOC3ARLEN           (_ADI_MSK_3(0x00000800,0x00000800U, uint16_t  ))    /*  Enable for fine control on RTCOC3 period and duty cycle. */

#define BITM_RTC_CR4OC_RTCOC2ARLEN           (_ADI_MSK_3(0x00000400,0x00000400U, uint16_t  ))    /*  Enable for fine control on RTCOC2 period and duty cycle. */

#define BITM_RTC_CR4OC_RTCOC1ARLEN           (_ADI_MSK_3(0x00000200,0x00000200U, uint16_t  ))    /*  Enable for fine control on RTCOC1 period and duty cycle. */

#define BITM_RTC_CR4OC_RTCOC4POL             (_ADI_MSK_3(0x00000100,0x00000100U, uint16_t  ))    /*  RTCOC4 Polarity Control */

#define BITM_RTC_CR4OC_RTCOC3POL             (_ADI_MSK_3(0x00000080,0x00000080U, uint16_t  ))    /*  RTCOC3 Polarity Control */

#define BITM_RTC_CR4OC_RTCOC2POL             (_ADI_MSK_3(0x00000040,0x00000040U, uint16_t  ))    /*  RTCOC2 Polarity Control */

#define BITM_RTC_CR4OC_RTCOC1POL             (_ADI_MSK_3(0x00000020,0x00000020U, uint16_t  ))    /*  RTCOC1 Polarity Control */

#define BITM_RTC_CR4OC_RTCOC4MSKEN           (_ADI_MSK_3(0x00000010,0x00000010U, uint16_t  ))    /*  Enable for thermometer-code masking of the Output Compare 4 channel. */

#define BITM_RTC_CR4OC_RTCOC3MSKEN           (_ADI_MSK_3(0x00000008,0x00000008U, uint16_t  ))    /*  Enable for thermometer-code masking of the Output Compare 3 channel. */

#define BITM_RTC_CR4OC_RTCOC2MSKEN           (_ADI_MSK_3(0x00000004,0x00000004U, uint16_t  ))    /*  Enable for thermometer-code masking of the Output Compare 2 channel. */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_OCMSK_RTCOC4MSK             12            /*  RTCOC4 period control */
#define BITP_RTC_OCMSK_RTCOC3MSK              8            /*  RTCOC3 period control */
#define BITP_RTC_OCMSK_RTCOC2MSK              4            /*  RTCOC2 period control */
#define BITP_RTC_OCMSK_RTCOC1MSK              0            /*  Concatenation of thermometer-encoded masks for the 16-bit output compare channels */
#define BITM_RTC_OCMSK_RTCOC4MSK             (_ADI_MSK_3(0x0000F000,0x0000F000U, uint16_t  ))    /*  RTCOC4 period control */
#define BITM_RTC_OCMSK_RTCOC3MSK             (_ADI_MSK_3(0x00000F00,0x00000F00U, uint16_t  ))    /*  RTCOC3 period control */
#define BITM_RTC_OCMSK_RTCOC2MSK             (_ADI_MSK_3(0x000000F0,0x000000F0U, uint16_t  ))    /*  RTCOC2 period control */
#define BITM_RTC_OCMSK_RTCOC1MSK             (_ADI_MSK_3(0x0000000F,0x0000000FU, uint16_t  ))    /*  Concatenation of thermometer-encoded masks for the 16-bit output compare channels */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_OC1_RTCOC1                   0            /*  RTC Output Compare 1 Channel */
#define BITM_RTC_OC1_RTCOC1                  (_ADI_MSK_3(0x0000FFFF,0x0000FFFFU, uint16_t  ))    /*  RTC Output Compare 1 Channel */

/* -------------------------------------------------------------------------------------------------------------------------
          RTC_OC2                              Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_OC2_RTCOC2                   0            /*  RTC Output Compare 2 channel. Scheduled alarm target time. */
#define BITM_RTC_OC2_RTCOC2                  (_ADI_MSK_3(0x0000FFFF,0x0000FFFFU, uint16_t  ))    /*  RTC Output Compare 2 channel. Scheduled alarm target time. */

/* -------------------------------------------------------------------------------------------------------------------------
          RTC_OC3                              Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_OC3_RTCOC3                   0            /*  RTC Output Compare 3 channel. Scheduled alarm target time. */
#define BITM_RTC_OC3_RTCOC3                  (_ADI_MSK_3(0x0000FFFF,0x0000FFFFU, uint16_t  ))    /*  RTC Output Compare 3 channel. Scheduled alarm target time. */

/* -------------------------------------------------------------------------------------------------------------------------
          RTC_OC4                              Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_OC4_RTCOC4                   0            /*  RTC Output Compare 4 channel. Scheduled alarm target time. */
#define BITM_RTC_OC4_RTCOC4                  (_ADI_MSK_3(0x0000FFFF,0x0000FFFFU, uint16_t  ))    /*  RTC Output Compare 4 channel. Scheduled alarm target time. */

/* -------------------------------------------------------------------------------------------------------------------------
          RTC_SR4                              Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_SR4_WSYNCOCMSKOT            15            /*  Synchronization status of posted writes to RTC On Time Masks for Output Compare Channel Register */
...
#define BITP_RTC_SR4_WSYNCOC4                 9            /*  Synchronisation status of posted writes to RTCOC4 */
#define BITP_RTC_SR4_WSYNCOC3                 8            /*  Synchronisation status of posted writes to RTCOC3 */
#define BITP_RTC_SR4_WSYNCOC2                 7            /*  Synchronization status of posted writes to RTCOC2. */
...
#define BITM_RTC_SR4_WSYNCOCMSKOT            (_ADI_MSK_3(0x00008000,0x00008000U, uint16_t  ))    /*  Synchronization status of posted writes to RTC On Time Masks for Output Compare Channel Register */
...
#define BITM_RTC_SR4_WSYNCOC4                (_ADI_MSK_3(0x00000200,0x00000200U, uint16_t  ))    /*  Synchronisation status of posted writes to RTCOC4 */

#define BITM_RTC_SR4_WSYNCOC3                (_ADI_MSK_3(0x00000100,0x00000100U, uint16_t  ))    /*  Synchronisation status of posted writes to RTCOC3 */

#define BITM_RTC_SR4_WSYNCOC2                (_ADI_MSK_3(0x00000080,0x00000080U, uint16_t  ))    /*  Synchronization status of posted writes to RTCOC2. */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_SR5_WPENDOCMSKOT            15            /*  Pending status of posted writes to RTC Masks for Output Compare Channel Register */
...
#define BITP_RTC_SR5_WPENDOC4                 9            /*  Pending status of posted writes to RTCOC4 */
#define BITP_RTC_SR5_WPENDOC3                 8            /*  Pending status of posted writes to RTCOC3 */
#define BITP_RTC_SR5_WPENDOC2                 7            /*  Pending status of posted writes to RTCOC2 */
...
#define BITM_RTC_SR5_WPENDOCMSKOT            (_ADI_MSK_3(0x00008000,0x00008000U, uint16_t  ))    /*  Pending status of posted writes to RTC Masks for Output Compare Channel Register */
...
#define BITM_RTC_SR5_WPENDOC4                (_ADI_MSK_3(0x00000200,0x00000200U, uint16_t  ))    /*  Pending status of posted writes to RTCOC4 */

#define BITM_RTC_SR5_WPENDOC3                (_ADI_MSK_3(0x00000100,0x00000100U, uint16_t  ))    /*  Pending status of posted writes to RTCOC3 */

#define BITM_RTC_SR5_WPENDOC2                (_ADI_MSK_3(0x00000080,0x00000080U, uint16_t  ))    /*  Pending status of posted writes to RTCOC2 */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_OC1TGT_RTCOC1TGT             0            /*  Provides visibility to the CPU of the current target value for the output-compare channel 1, taking account of any possible auto-reloading */
#define BITM_RTC_OC1TGT_RTCOC1TGT            (_ADI_MSK_3(0x0000FFFF,0x0000FFFFU, uint16_t  ))    /*  Provides visibility to the CPU of the current target value for the output-compare channel 1, taking account of any possible auto-reloading */
...
/* -------------------------------------------------------------------------------------------------------------------------
          RTC_OC2TGT                           Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_OC2TGT_RTCOC2TGT             0            /*  Current, cumulative target time for Output Compare Channel 1, taking account of any auto-reloading */
#define BITM_RTC_OC2TGT_RTCOC2TGT            (_ADI_MSK_3(0x0000FFFF,0x0000FFFFU, uint16_t  ))    /*  Current, cumulative target time for Output Compare Channel 1, taking account of any auto-reloading */

/* -------------------------------------------------------------------------------------------------------------------------
          RTC_OC3TGT                           Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_OC3TGT_RTCOC3TGT             0            /*  Current, cumulative target time for Output Compare Channel 1, taking account of any auto-reloading */
#define BITM_RTC_OC3TGT_RTCOC3TGT            (_ADI_MSK_3(0x0000FFFF,0x0000FFFFU, uint16_t  ))    /*  Current, cumulative target time for Output Compare Channel 1, taking account of any auto-reloading */

/* -------------------------------------------------------------------------------------------------------------------------
          RTC_OC1LOWDUR                        Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_OC1LOWDUR_RTCOC1LOWDUR       0            /*  Low Duration for RTCOC1. */
#define BITM_RTC_OC1LOWDUR_RTCOC1LOWDUR      (_ADI_MSK_3(0x0000FFFF,0x0000FFFFU, uint16_t  ))    /*  Low Duration for RTCOC1. */

/* -------------------------------------------------------------------------------------------------------------------------
          RTC_OC2LOWDUR                        Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_OC2LOWDUR_RTCOC2LOWDUR       0            /*  Low Duration for RTCOC2. */
#define BITM_RTC_OC2LOWDUR_RTCOC2LOWDUR      (_ADI_MSK_3(0x0000FFFF,0x0000FFFFU, uint16_t  ))    /*  Low Duration for RTCOC2. */

/* -------------------------------------------------------------------------------------------------------------------------
          RTC_OC3LOWDUR                        Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_OC3LOWDUR_RTCOC3LOWDUR       0            /*  Low Duration for RTCOC3. */
#define BITM_RTC_OC3LOWDUR_RTCOC3LOWDUR      (_ADI_MSK_3(0x0000FFFF,0x0000FFFFU, uint16_t  ))    /*  Low Duration for RTCOC3. */

/* -------------------------------------------------------------------------------------------------------------------------
          RTC_OC1HIGHDUR                       Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_OC1HIGHDUR_RTCOC1HIGHDUR     0            /*  High Duration for RTCOC1. */
#define BITM_RTC_OC1HIGHDUR_RTCOC1HIGHDUR    (_ADI_MSK_3(0x0000FFFF,0x0000FFFFU, uint16_t  ))    /*  High Duration for RTCOC1. */

/* -------------------------------------------------------------------------------------------------------------------------
          RTC_OC2HIGHDUR                       Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_OC2HIGHDUR_RTCOC2HIGHDUR     0            /*  High Duration for RTCOC2. */
#define BITM_RTC_OC2HIGHDUR_RTCOC2HIGHDUR    (_ADI_MSK_3(0x0000FFFF,0x0000FFFFU, uint16_t  ))    /*  High Duration for RTCOC2. */

/* -------------------------------------------------------------------------------------------------------------------------
          RTC_OC3HIGHDUR                       Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_OC3HIGHDUR_RTCOC3HIGHDUR     0            /*  High Duration for RTCOC3. */
#define BITM_RTC_OC3HIGHDUR_RTCOC3HIGHDUR    (_ADI_MSK_3(0x0000FFFF,0x0000FFFFU, uint16_t  ))    /*  High Duration for RTCOC3. */

/* -------------------------------------------------------------------------------------------------------------------------
          RTC_OCMSKOT                          Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_OCMSKOT_RTCOC4MSKOT         12            /*  RTCOC4 on time control */
#define BITP_RTC_OCMSKOT_RTCOC3MSKOT          8            /*  RTCOC3 on time control */
#define BITP_RTC_OCMSKOT_RTCOC2MSKOT          4            /*  RTCOC2 on time control */
#define BITP_RTC_OCMSKOT_RTCOC1MSKOT          0            /*  Concatenation of thermometer-encoded masks for the 16-bit output compare channels */
#define BITM_RTC_OCMSKOT_RTCOC4MSKOT         (_ADI_MSK_3(0x0000F000,0x0000F000U, uint16_t  ))    /*  RTCOC4 on time control */
#define BITM_RTC_OCMSKOT_RTCOC3MSKOT         (_ADI_MSK_3(0x00000F00,0x00000F00U, uint16_t  ))    /*  RTCOC3 on time control */
#define BITM_RTC_OCMSKOT_RTCOC2MSKOT         (_ADI_MSK_3(0x000000F0,0x000000F0U, uint16_t  ))    /*  RTCOC2 on time control */
#define BITM_RTC_OCMSKOT_RTCOC1MSKOT         (_ADI_MSK_3(0x0000000F,0x0000000FU, uint16_t  ))    /*  Concatenation of thermometer-encoded masks for the 16-bit output compare channels */

/* -------------------------------------------------------------------------------------------------------------------------
          RTC_CR5OCS                           Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_CR5OCS_OC3SMPMTCHIRQEN      11            /*  Sample activity Interrupt enable for RTC Output Compare Channel 3 */
#define BITP_RTC_CR5OCS_OC3SMPEN              8            /*  GPIO input sample enable for RTC Output Compare Channel 3 */
#define BITP_RTC_CR5OCS_OC2SMPMTCHIRQEN       7            /*  Sample activity Interrupt enable for RTC Output Compare Channel 2 */
#define BITP_RTC_CR5OCS_OC2SMPEN              4            /*  GPIO input sample enable for RTC Output Compare Channel 2 */
#define BITP_RTC_CR5OCS_OC1SMPMTCHIRQEN       3            /*  Sample activity Interrupt enable for RTC Output Compare Channel 1. */
#define BITP_RTC_CR5OCS_OC1SMPEN              0            /*  GPIO input sample enable for RTC Output Compare Channel 1 */
#define BITM_RTC_CR5OCS_OC3SMPMTCHIRQEN      (_ADI_MSK_3(0x00000800,0x00000800U, uint16_t  ))    /*  Sample activity Interrupt enable for RTC Output Compare Channel 3 */
#define BITM_RTC_CR5OCS_OC3SMPEN             (_ADI_MSK_3(0x00000700,0x00000700U, uint16_t  ))    /*  GPIO input sample enable for RTC Output Compare Channel 3 */
#define BITM_RTC_CR5OCS_OC2SMPMTCHIRQEN      (_ADI_MSK_3(0x00000080,0x00000080U, uint16_t  ))    /*  Sample activity Interrupt enable for RTC Output Compare Channel 2 */
#define BITM_RTC_CR5OCS_OC2SMPEN             (_ADI_MSK_3(0x00000070,0x00000070U, uint16_t  ))    /*  GPIO input sample enable for RTC Output Compare Channel 2 */
#define BITM_RTC_CR5OCS_OC1SMPMTCHIRQEN      (_ADI_MSK_3(0x00000008,0x00000008U, uint16_t  ))    /*  Sample activity Interrupt enable for RTC Output Compare Channel 1. */
#define BITM_RTC_CR5OCS_OC1SMPEN             (_ADI_MSK_3(0x00000007,0x00000007U, uint16_t  ))    /*  GPIO input sample enable for RTC Output Compare Channel 1 */

/* -------------------------------------------------------------------------------------------------------------------------
          RTC_CR6OCS                           Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_CR6OCS_OC3SMPONRE           10            /*  GPIO Sample around Rising Edge of Output Compare Channel 3 */
#define BITP_RTC_CR6OCS_OC3SMPONFE            8            /*  GPIO Sample around Falling Edge of Output Compare Channel 3 */
#define BITP_RTC_CR6OCS_OC2SMPONRE            6            /*  GPIO Sample around Rising Edge of Output Compare Channel 2 */
#define BITP_RTC_CR6OCS_OC2SMPONFE            4            /*  GPIO Sample around Falling Edge of Output Compare Channel 2 */
#define BITP_RTC_CR6OCS_OC1SMPONRE            2            /*  GPIO Sample around Rising Edge of Output Compare Channel 1 */
#define BITP_RTC_CR6OCS_OC1SMPONFE            0            /*  GPIO Sample around Falling Edge of Output Compare Channel 1 */

#define BITM_RTC_CR6OCS_OC3SMPONRE           (_ADI_MSK_3(0x00000C00,0x00000C00U, uint16_t  ))    /*  GPIO Sample around Rising Edge of Output Compare Channel 3 */

#define BITM_RTC_CR6OCS_OC3SMPONFE           (_ADI_MSK_3(0x00000300,0x00000300U, uint16_t  ))    /*  GPIO Sample around Falling Edge of Output Compare Channel 3 */

#define BITM_RTC_CR6OCS_OC2SMPONRE           (_ADI_MSK_3(0x000000C0,0x000000C0U, uint16_t  ))    /*  GPIO Sample around Rising Edge of Output Compare Channel 2 */

#define BITM_RTC_CR6OCS_OC2SMPONFE           (_ADI_MSK_3(0x00000030,0x00000030U, uint16_t  ))    /*  GPIO Sample around Falling Edge of Output Compare Channel 2 */

#define BITM_RTC_CR6OCS_OC1SMPONRE           (_ADI_MSK_3(0x0000000C,0x0000000CU, uint16_t  ))    /*  GPIO Sample around Rising Edge of Output Compare Channel 1 */

#define BITM_RTC_CR6OCS_OC1SMPONFE           (_ADI_MSK_3(0x00000003,0x00000003U, uint16_t  ))    /*  GPIO Sample around Falling Edge of Output Compare Channel 1 */
#define ENUM_RTC_CR6OCS_OC3NORES             (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  OC3SMPONRE: No sampling of input around rising edge */
#define ENUM_RTC_CR6OCS_OC3BRES              (_ADI_MSK_3(0x00000400,0x00000400U, uint16_t  ))    /*  OC3SMPONRE: Input sampled one clock cycle before rising edge of OPC */
#define ENUM_RTC_CR6OCS_OC3RES               (_ADI_MSK_3(0x00000800,0x00000800U, uint16_t  ))    /*  OC3SMPONRE: Input sampled at rising edge of OPC */
#define ENUM_RTC_CR6OCS_OC3ARES              (_ADI_MSK_3(0x00000C00,0x00000C00U, uint16_t  ))    /*  OC3SMPONRE: Input sampled one clock cycle after rising edge of OPC */
#define ENUM_RTC_CR6OCS_OC3NOFES             (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  OC3SMPONFE: No sampling of input around falling edge */
#define ENUM_RTC_CR6OCS_OC3BFES              (_ADI_MSK_3(0x00000100,0x00000100U, uint16_t  ))    /*  OC3SMPONFE: Input sampled one clock cycle before falling edge of OPC */
#define ENUM_RTC_CR6OCS_OC3FES               (_ADI_MSK_3(0x00000200,0x00000200U, uint16_t  ))    /*  OC3SMPONFE: Input sampled at falling edge of OPC */
#define ENUM_RTC_CR6OCS_OC3AFES              (_ADI_MSK_3(0x00000300,0x00000300U, uint16_t  ))    /*  OC3SMPONFE: Input sampled one clock cycle after falling edge of OPC */
#define ENUM_RTC_CR6OCS_OC2NORES             (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  OC2SMPONRE: No sampling of input around rising edge */
#define ENUM_RTC_CR6OCS_OC2BRES              (_ADI_MSK_3(0x00000040,0x00000040U, uint16_t  ))    /*  OC2SMPONRE: Input sampled one clock cycle before rising edge of OPC */
#define ENUM_RTC_CR6OCS_OC2RES               (_ADI_MSK_3(0x00000080,0x00000080U, uint16_t  ))    /*  OC2SMPONRE: Input sampled at rising edge of OPC */
#define ENUM_RTC_CR6OCS_OC2ARES              (_ADI_MSK_3(0x000000C0,0x000000C0U, uint16_t  ))    /*  OC2SMPONRE: Input sampled one clock cycle after rising edge of OPC */
#define ENUM_RTC_CR6OCS_OC2NOFES             (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  OC2SMPONFE: No sampling of input around falling edge */
#define ENUM_RTC_CR6OCS_OC2BFES              (_ADI_MSK_3(0x00000010,0x00000010U, uint16_t  ))    /*  OC2SMPONFE: Input sampled one clock cycle before falling edge of OPC */
#define ENUM_RTC_CR6OCS_OC2FES               (_ADI_MSK_3(0x00000020,0x00000020U, uint16_t  ))    /*  OC2SMPONFE: Input sampled at falling edge of OPC */
#define ENUM_RTC_CR6OCS_OC2AFES              (_ADI_MSK_3(0x00000030,0x00000030U, uint16_t  ))    /*  OC2SMPONFE: Input sampled one clock cycle after falling edge of OPC */
#define ENUM_RTC_CR6OCS_OC1NORES             (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  OC1SMPONRE: No sampling of input around rising edge */
#define ENUM_RTC_CR6OCS_OC1BRES              (_ADI_MSK_3(0x00000004,0x00000004U, uint16_t  ))    /*  OC1SMPONRE: Input sampled one clock cycle before rising edge of OPC */
#define ENUM_RTC_CR6OCS_OC1RES               (_ADI_MSK_3(0x00000008,0x00000008U, uint16_t  ))    /*  OC1SMPONRE: Input sampled at rising edge of OPC */
#define ENUM_RTC_CR6OCS_OC1ARES              (_ADI_MSK_3(0x0000000C,0x0000000CU, uint16_t  ))    /*  OC1SMPONRE: Input sampled one clock cycle after rising edge of OPC */
#define ENUM_RTC_CR6OCS_OC1NOFES             (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  OC1SMPONFE: No sampling of input around falling edge */
#define ENUM_RTC_CR6OCS_OC1BFES              (_ADI_MSK_3(0x00000001,0x00000001U, uint16_t  ))    /*  OC1SMPONFE: Input sampled one clock cycle before falling edge of OPC */
#define ENUM_RTC_CR6OCS_OC1FES               (_ADI_MSK_3(0x00000002,0x00000002U, uint16_t  ))    /*  OC1SMPONFE: Input sampled at falling edge of OPC */
#define ENUM_RTC_CR6OCS_OC1AFES              (_ADI_MSK_3(0x00000003,0x00000003U, uint16_t  ))    /*  OC1SMPONFE: Input sampled one clock cycle after falling edge of OPC */

/* -------------------------------------------------------------------------------------------------------------------------
          RTC_CR7OCS                           Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_CR7OCS_OC3SMPPTRN           13            /*  Sample activity selection for Output Compare Channel 3 */
#define BITP_RTC_CR7OCS_OC3SMPEXP            10            /*  Expected GPIO Sample for Output Compare Channel 3 */
#define BITP_RTC_CR7OCS_OC2SMPPTRN            8            /*  Sample activity selection for Output Compare Channel 2 */
#define BITP_RTC_CR7OCS_OC2SMPEXP             5            /*  Expected GPIO Sample for Output Compare Channel 2 */
#define BITP_RTC_CR7OCS_OC1SMPPTRN            3            /*  Sample activity selection for Output Compare Channel 1 */
#define BITP_RTC_CR7OCS_OC1SMPEXP             0            /*  Expected GPIO Sample for Output Compare Channel 1 */

#define BITM_RTC_CR7OCS_OC3SMPPTRN           (_ADI_MSK_3(0x00006000,0x00006000U, uint16_t  ))    /*  Sample activity selection for Output Compare Channel 3 */
#define BITM_RTC_CR7OCS_OC3SMPEXP            (_ADI_MSK_3(0x00001C00,0x00001C00U, uint16_t  ))    /*  Expected GPIO Sample for Output Compare Channel 3 */

#define BITM_RTC_CR7OCS_OC2SMPPTRN           (_ADI_MSK_3(0x00000300,0x00000300U, uint16_t  ))    /*  Sample activity selection for Output Compare Channel 2 */
#define BITM_RTC_CR7OCS_OC2SMPEXP            (_ADI_MSK_3(0x000000E0,0x000000E0U, uint16_t  ))    /*  Expected GPIO Sample for Output Compare Channel 2 */

#define BITM_RTC_CR7OCS_OC1SMPPTRN           (_ADI_MSK_3(0x00000018,0x00000018U, uint16_t  ))    /*  Sample activity selection for Output Compare Channel 1 */
#define BITM_RTC_CR7OCS_OC1SMPEXP            (_ADI_MSK_3(0x00000007,0x00000007U, uint16_t  ))    /*  Expected GPIO Sample for Output Compare Channel 1 */
#define ENUM_RTC_CR7OCS_OC3SMPCHNG           (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  OC3SMPPTRN: Current GPIO sample is not same as previous sample */
#define ENUM_RTC_CR7OCS_OC3SMPSAME           (_ADI_MSK_3(0x00002000,0x00002000U, uint16_t  ))    /*  OC3SMPPTRN: Current GPIO sample is same as previous sample */
#define ENUM_RTC_CR7OCS_OC3SMPMTCH           (_ADI_MSK_3(0x00004000,0x00004000U, uint16_t  ))    /*  OC3SMPPTRN: Current GPIO sample is same as expected sample */
#define ENUM_RTC_CR7OCS_OC3SMPNOMTCH         (_ADI_MSK_3(0x00006000,0x00006000U, uint16_t  ))    /*  OC3SMPPTRN: Current GPIO sample is not same as expected sample */
#define ENUM_RTC_CR7OCS_OC2SMPCHNG           (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  OC2SMPPTRN: Current GPIO sample is not same as previous sample */
#define ENUM_RTC_CR7OCS_OC2SMPSAME           (_ADI_MSK_3(0x00000100,0x00000100U, uint16_t  ))    /*  OC2SMPPTRN: Current GPIO sample is same as previous sample */
#define ENUM_RTC_CR7OCS_OC2SMPMTCH           (_ADI_MSK_3(0x00000200,0x00000200U, uint16_t  ))    /*  OC2SMPPTRN: Current GPIO sample is same as expected sample */
#define ENUM_RTC_CR7OCS_OC2SMPNOMTCH         (_ADI_MSK_3(0x00000300,0x00000300U, uint16_t  ))    /*  OC2SMPPTRN: Current GPIO sample is not same as expected sample */
#define ENUM_RTC_CR7OCS_OC1SMPCHNG           (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  OC1SMPPTRN: Current GPIO sample is not same as previous sample */
#define ENUM_RTC_CR7OCS_OC1SMPSAME           (_ADI_MSK_3(0x00000008,0x00000008U, uint16_t  ))    /*  OC1SMPPTRN: Current GPIO sample is same as previous sample */
#define ENUM_RTC_CR7OCS_OC1SMPMTCH           (_ADI_MSK_3(0x00000010,0x00000010U, uint16_t  ))    /*  OC1SMPPTRN: Current GPIO sample is same as expected sample */
#define ENUM_RTC_CR7OCS_OC1SMPNOMTCH         (_ADI_MSK_3(0x00000018,0x00000018U, uint16_t  ))    /*  OC1SMPPTRN: Current GPIO sample is not same as expected sample */

/* -------------------------------------------------------------------------------------------------------------------------
          RTC_SR7                              Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_SR7_RTCOC4OUT               15            /*  Output value for RTC Output Compare Channel 4 */
#define BITP_RTC_SR7_RTCOC3OUT               14            /*  Output value for RTC Output Compare Channel 3 */
#define BITP_RTC_SR7_RTCOC2OUT               13            /*  Output value for RTC Output Compare Channel 2 */
#define BITP_RTC_SR7_RTCOC1OUT               12            /*  Output value for RTC Output Compare Channel 1 */
#define BITP_RTC_SR7_RTCOC3SMPMTCHIRQ        11            /*  Sticky status of GPIO sample pattern match for RTC Output Compare Channel 3 */
#define BITP_RTC_SR7_RTCOC3SMP                8            /*  Latest GPIO sample for RTC Output Compare Channel 3 */
#define BITP_RTC_SR7_RTCOC2SMPMTCHIRQ         7            /*  Sticky status of GPIO sample pattern match for RTC Output Compare Channel 2 */
#define BITP_RTC_SR7_RTCOC2SMP                4            /*  Latest GPIO sample for RTC Output Compare Channel 2 */
#define BITP_RTC_SR7_RTCOC1SMPMTCHIRQ         3            /*  Sticky status of GPIO sample pattern match for RTC Output Compare Channel 1 */
#define BITP_RTC_SR7_RTCOC1SMP                0            /*  Latest GPIO sample for RTC Output Compare Channel 1 */
#define BITM_RTC_SR7_RTCOC4OUT               (_ADI_MSK_3(0x00008000,0x00008000U, uint16_t  ))    /*  Output value for RTC Output Compare Channel 4 */
#define BITM_RTC_SR7_RTCOC3OUT               (_ADI_MSK_3(0x00004000,0x00004000U, uint16_t  ))    /*  Output value for RTC Output Compare Channel 3 */
#define BITM_RTC_SR7_RTCOC2OUT               (_ADI_MSK_3(0x00002000,0x00002000U, uint16_t  ))    /*  Output value for RTC Output Compare Channel 2 */
#define BITM_RTC_SR7_RTCOC1OUT               (_ADI_MSK_3(0x00001000,0x00001000U, uint16_t  ))    /*  Output value for RTC Output Compare Channel 1 */
#define BITM_RTC_SR7_RTCOC3SMPMTCHIRQ        (_ADI_MSK_3(0x00000800,0x00000800U, uint16_t  ))    /*  Sticky status of GPIO sample pattern match for RTC Output Compare Channel 3 */
#define BITM_RTC_SR7_RTCOC3SMP               (_ADI_MSK_3(0x00000700,0x00000700U, uint16_t  ))    /*  Latest GPIO sample for RTC Output Compare Channel 3 */
#define BITM_RTC_SR7_RTCOC2SMPMTCHIRQ        (_ADI_MSK_3(0x00000080,0x00000080U, uint16_t  ))    /*  Sticky status of GPIO sample pattern match for RTC Output Compare Channel 2 */
#define BITM_RTC_SR7_RTCOC2SMP               (_ADI_MSK_3(0x00000070,0x00000070U, uint16_t  ))    /*  Latest GPIO sample for RTC Output Compare Channel 2 */
#define BITM_RTC_SR7_RTCOC1SMPMTCHIRQ        (_ADI_MSK_3(0x00000008,0x00000008U, uint16_t  ))    /*  Sticky status of GPIO sample pattern match for RTC Output Compare Channel 1 */
#define BITM_RTC_SR7_RTCOC1SMP               (_ADI_MSK_3(0x00000007,0x00000007U, uint16_t  ))    /*  Latest GPIO sample for RTC Output Compare Channel 1 */

/* -------------------------------------------------------------------------------------------------------------------------
          RTC_SR8                              Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_SR8_WSYNCGPMUX1             13            /*  Synchronization status of posted writes to RTCGPMUX1 pin mux control for Output Compare Channel Register */
#define BITP_RTC_SR8_WSYNCGPMUX0             12            /*  Synchronization status of posted writes to RTCGPMUX0 pin mux control for Output Compare Channel Register */
#define BITP_RTC_SR8_WSYNCSR7                11            /*  Synchronization status of posted writes to RTCSR7 sample control for Output Compare Channel Register */
#define BITP_RTC_SR8_WSYNCCR7OCS             10            /*  Synchronization status of posted writes to RTCOC3 sample control for Output Compare Channel Register */
#define BITP_RTC_SR8_WSYNCCR6OCS              9            /*  Synchronization status of posted writes to RTCOC2 sample control for Output Compare Channel Register */
#define BITP_RTC_SR8_WSYNCCR5OCS              8            /*  Synchronization status of posted writes to RTCOC1 sample control for Output Compare Channel Register */
#define BITP_RTC_SR8_WSYNCOC3HIGHDUR          6            /*  Synchronization status of posted writes to RTCOC3 low duration for Output Compare Channel Register */
#define BITP_RTC_SR8_WSYNCOC2HIGHDUR          5            /*  Synchronization status of posted writes to RTCOC2 low duration for Output Compare Channel Register */
#define BITP_RTC_SR8_WSYNCOC1HIGHDUR          4            /*  Synchronization status of posted writes to RTCOC1 low duration for Output Compare Channel Register */
#define BITP_RTC_SR8_WSYNCOC3LOWDUR           2            /*  Synchronization status of posted writes to RTCOC3 low duration for Output Compare Channel Register */
#define BITP_RTC_SR8_WSYNCOC2LOWDUR           1            /*  Synchronization status of posted writes to RTCOC2 low duration for Output Compare Channel Register */
#define BITP_RTC_SR8_WSYNCOC1LOWDUR           0            /*  Synchronization status of posted writes to RTCOC1 low duration for Output Compare Channel Register */

#define BITM_RTC_SR8_WSYNCGPMUX1             (_ADI_MSK_3(0x00002000,0x00002000U, uint16_t  ))    /*  Synchronization status of posted writes to RTCGPMUX1 pin mux control for Output Compare Channel Register */

#define BITM_RTC_SR8_WSYNCGPMUX0             (_ADI_MSK_3(0x00001000,0x00001000U, uint16_t  ))    /*  Synchronization status of posted writes to RTCGPMUX0 pin mux control for Output Compare Channel Register */

#define BITM_RTC_SR8_WSYNCSR7                (_ADI_MSK_3(0x00000800,0x00000800U, uint16_t  ))    /*  Synchronization status of posted writes to RTCSR7 sample control for Output Compare Channel Register */

#define BITM_RTC_SR8_WSYNCCR7OCS             (_ADI_MSK_3(0x00000400,0x00000400U, uint16_t  ))    /*  Synchronization status of posted writes to RTCOC3 sample control for Output Compare Channel Register */

#define BITM_RTC_SR8_WSYNCCR6OCS             (_ADI_MSK_3(0x00000200,0x00000200U, uint16_t  ))    /*  Synchronization status of posted writes to RTCOC2 sample control for Output Compare Channel Register */

#define BITM_RTC_SR8_WSYNCCR5OCS             (_ADI_MSK_3(0x00000100,0x00000100U, uint16_t  ))    /*  Synchronization status of posted writes to RTCOC1 sample control for Output Compare Channel Register */

#define BITM_RTC_SR8_WSYNCOC3HIGHDUR         (_ADI_MSK_3(0x00000040,0x00000040U, uint16_t  ))    /*  Synchronization status of posted writes to RTCOC3 low duration for Output Compare Channel Register */

#define BITM_RTC_SR8_WSYNCOC2HIGHDUR         (_ADI_MSK_3(0x00000020,0x00000020U, uint16_t  ))    /*  Synchronization status of posted writes to RTCOC2 low duration for Output Compare Channel Register */

#define BITM_RTC_SR8_WSYNCOC1HIGHDUR         (_ADI_MSK_3(0x00000010,0x00000010U, uint16_t  ))    /*  Synchronization status of posted writes to RTCOC1 low duration for Output Compare Channel Register */

#define BITM_RTC_SR8_WSYNCOC3LOWDUR          (_ADI_MSK_3(0x00000004,0x00000004U, uint16_t  ))    /*  Synchronization status of posted writes to RTCOC3 low duration for Output Compare Channel Register */

#define BITM_RTC_SR8_WSYNCOC2LOWDUR          (_ADI_MSK_3(0x00000002,0x00000002U, uint16_t  ))    /*  Synchronization status of posted writes to RTCOC2 low duration for Output Compare Channel Register */

#define BITM_RTC_SR8_WSYNCOC1LOWDUR          (_ADI_MSK_3(0x00000001,0x00000001U, uint16_t  ))    /*  Synchronization status of posted writes to RTCOC1 low duration for Output Compare Channel Register */

/* -------------------------------------------------------------------------------------------------------------------------
          RTC_SR9                              Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_SR9_WPENDGPMUX1             13            /*  Pending status of posted writes to RTCGPMUX1 for Output Compare Channel Register */
#define BITP_RTC_SR9_WPENDGPMUX0             12            /*  Pending status of posted writes to RTCGPMUX0 for Output Compare Channel Register */
#define BITP_RTC_SR9_WPENDSR7                11            /*  Pending status of posted writes to RTCSR7 status for Output Compare Channel Register */
#define BITP_RTC_SR9_WPENDCR7OCS             10            /*  Pending status of posted writes to RTCOC3 Sample control for Output Compare Channel Register */
#define BITP_RTC_SR9_WPENDCR6OCS              9            /*  Pending status of posted writes to RTCOC2 Sample control for Output Compare Channel Register */
#define BITP_RTC_SR9_WPENDCR5OCS              8            /*  Pending status of posted writes to RTCOC1 Sample control for Output Compare Channel Register */
#define BITP_RTC_SR9_WPENDOC3HIGHDUR          6            /*  Pending status of posted writes to RTCOC3 High Duration for Output Compare Channel Register */
#define BITP_RTC_SR9_WPENDOC2HIGHDUR          5            /*  Pending status of posted writes to RTCOC2 High Duration for Output Compare Channel Register */
#define BITP_RTC_SR9_WPENDOC1HIGHDUR          4            /*  Pending status of posted writes to RTCOC1 High Duration for Output Compare Channel Register */
#define BITP_RTC_SR9_WPENDOC3LOWDUR           2            /*  Pending status of posted writes to RTCOC3 Low Duration for Output Compare Channel Register */
#define BITP_RTC_SR9_WPENDOC2LOWDUR           1            /*  Pending status of posted writes to RTCOC2 Low Duration for Output Compare Channel Register */
#define BITP_RTC_SR9_WPENDOC1LOWDUR           0            /*  Pending status of posted writes to RTCOC1 Low Duration for Output Compare Channel Register */

#define BITM_RTC_SR9_WPENDGPMUX1             (_ADI_MSK_3(0x00002000,0x00002000U, uint16_t  ))    /*  Pending status of posted writes to RTCGPMUX1 for Output Compare Channel Register */

#define BITM_RTC_SR9_WPENDGPMUX0             (_ADI_MSK_3(0x00001000,0x00001000U, uint16_t  ))    /*  Pending status of posted writes to RTCGPMUX0 for Output Compare Channel Register */

#define BITM_RTC_SR9_WPENDSR7                (_ADI_MSK_3(0x00000800,0x00000800U, uint16_t  ))    /*  Pending status of posted writes to RTCSR7 status for Output Compare Channel Register */

#define BITM_RTC_SR9_WPENDCR7OCS             (_ADI_MSK_3(0x00000400,0x00000400U, uint16_t  ))    /*  Pending status of posted writes to RTCOC3 Sample control for Output Compare Channel Register */

#define BITM_RTC_SR9_WPENDCR6OCS             (_ADI_MSK_3(0x00000200,0x00000200U, uint16_t  ))    /*  Pending status of posted writes to RTCOC2 Sample control for Output Compare Channel Register */

#define BITM_RTC_SR9_WPENDCR5OCS             (_ADI_MSK_3(0x00000100,0x00000100U, uint16_t  ))    /*  Pending status of posted writes to RTCOC1 Sample control for Output Compare Channel Register */

#define BITM_RTC_SR9_WPENDOC3HIGHDUR         (_ADI_MSK_3(0x00000040,0x00000040U, uint16_t  ))    /*  Pending status of posted writes to RTCOC3 High Duration for Output Compare Channel Register */

#define BITM_RTC_SR9_WPENDOC2HIGHDUR         (_ADI_MSK_3(0x00000020,0x00000020U, uint16_t  ))    /*  Pending status of posted writes to RTCOC2 High Duration for Output Compare Channel Register */

#define BITM_RTC_SR9_WPENDOC1HIGHDUR         (_ADI_MSK_3(0x00000010,0x00000010U, uint16_t  ))    /*  Pending status of posted writes to RTCOC1 High Duration for Output Compare Channel Register */

#define BITM_RTC_SR9_WPENDOC3LOWDUR          (_ADI_MSK_3(0x00000004,0x00000004U, uint16_t  ))    /*  Pending status of posted writes to RTCOC3 Low Duration for Output Compare Channel Register */

#define BITM_RTC_SR9_WPENDOC2LOWDUR          (_ADI_MSK_3(0x00000002,0x00000002U, uint16_t  ))    /*  Pending status of posted writes to RTCOC2 Low Duration for Output Compare Channel Register */

#define BITM_RTC_SR9_WPENDOC1LOWDUR          (_ADI_MSK_3(0x00000001,0x00000001U, uint16_t  ))    /*  Pending status of posted writes to RTCOC1 Low Duration for Output Compare Channel Register */

/* -------------------------------------------------------------------------------------------------------------------------
          RTC_GPMUX0                           Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_GPMUX0_OC2GPIN1SEL          12            /*  GPIO mux selection for output compare channel2 input1 */
#define BITP_RTC_GPMUX0_OC2GPIN0SEL           9            /*  GPIO mux selection for output compare channel2 input0 */
#define BITP_RTC_GPMUX0_OC1GPIN2SEL           6            /*  GPIO mux selection for output compare channel1 input2 */
#define BITP_RTC_GPMUX0_OC1GPIN1SEL           3            /*  GPIO mux selection for output compare channel1 input1 */
#define BITP_RTC_GPMUX0_OC1GPIN0SEL           0            /*  GPIO mux selection for output compare channel1 input0 */
#define BITM_RTC_GPMUX0_OC2GPIN1SEL          (_ADI_MSK_3(0x00007000,0x00007000U, uint16_t  ))    /*  GPIO mux selection for output compare channel2 input1 */
#define BITM_RTC_GPMUX0_OC2GPIN0SEL          (_ADI_MSK_3(0x00000E00,0x00000E00U, uint16_t  ))    /*  GPIO mux selection for output compare channel2 input0 */
#define BITM_RTC_GPMUX0_OC1GPIN2SEL          (_ADI_MSK_3(0x000001C0,0x000001C0U, uint16_t  ))    /*  GPIO mux selection for output compare channel1 input2 */
#define BITM_RTC_GPMUX0_OC1GPIN1SEL          (_ADI_MSK_3(0x00000038,0x00000038U, uint16_t  ))    /*  GPIO mux selection for output compare channel1 input1 */
#define BITM_RTC_GPMUX0_OC1GPIN0SEL          (_ADI_MSK_3(0x00000007,0x00000007U, uint16_t  ))    /*  GPIO mux selection for output compare channel1 input0 */

/* -------------------------------------------------------------------------------------------------------------------------
          RTC_GPMUX1                           Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_RTC_GPMUX1_OC3DIFFOUT           15            /*  Differential OPC out option for output compare channel3 */
#define BITP_RTC_GPMUX1_OC1DIFFOUT           14            /*  Differential OPC out option for output compare channel1 */
#define BITP_RTC_GPMUX1_OC3GPIN2SEL           9            /*  GPIO mux selection for output compare channel3 input2 */
#define BITP_RTC_GPMUX1_OC3GPIN1SEL           6            /*  GPIO mux selection for output compare channel3 input1 */
#define BITP_RTC_GPMUX1_OC3GPIN0SEL           3            /*  GPIO mux selection for output compare channel3 input0 */
#define BITP_RTC_GPMUX1_OC2GPIN2SEL           0            /*  GPIO mux selection for output compare channel2 input2 */
#define BITM_RTC_GPMUX1_OC3DIFFOUT           (_ADI_MSK_3(0x00008000,0x00008000U, uint16_t  ))    /*  Differential OPC out option for output compare channel3 */
#define BITM_RTC_GPMUX1_OC1DIFFOUT           (_ADI_MSK_3(0x00004000,0x00004000U, uint16_t  ))    /*  Differential OPC out option for output compare channel1 */
#define BITM_RTC_GPMUX1_OC3GPIN2SEL          (_ADI_MSK_3(0x00000E00,0x00000E00U, uint16_t  ))    /*  GPIO mux selection for output compare channel3 input2 */
#define BITM_RTC_GPMUX1_OC3GPIN1SEL          (_ADI_MSK_3(0x000001C0,0x000001C0U, uint16_t  ))    /*  GPIO mux selection for output compare channel3 input1 */
#define BITM_RTC_GPMUX1_OC3GPIN0SEL          (_ADI_MSK_3(0x00000038,0x00000038U, uint16_t  ))    /*  GPIO mux selection for output compare channel3 input0 */
#define BITM_RTC_GPMUX1_OC2GPIN2SEL          (_ADI_MSK_3(0x00000007,0x00000007U, uint16_t  ))    /*  GPIO mux selection for output compare channel2 input2 */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_SYS_SWDEN_VALUE                  0            /*  Writing the SWDEN register with "en" (0x6E65) or "EN" (0x4E45) will enable the SWD interface */
#define BITM_SYS_SWDEN_VALUE                 (_ADI_MSK_3(0x0000FFFF,0x0000FFFFU, uint16_t  ))    /*  Writing the SWDEN register with "en" (0x6E65) or "EN" (0x4E45) will enable the SWD interface */
...
#define BITP_I2C_MSTAT_MTXREQ                 2            /*  This bit will assert when the direction bit is 0 and transmit FIFO is not full */
...
#define BITM_I2C_MSTAT_MTXREQ                (_ADI_MSK_3(0x00000004,0x00000004U, uint16_t  ))    /*  This bit will assert when the direction bit is 0 and transmit FIFO is not full */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_SPI_FLOW_CTL_RDBURSTSZ           6            /*  Read data burst size minus 1 */
#define BITP_SPI_FLOW_CTL_RDYPOL              4            /*  Polarity of RDY/MISO line */
#define BITP_SPI_FLOW_CTL_MODE                0            /*  Flow control mode */
#define BITM_SPI_FLOW_CTL_RDBURSTSZ          (_ADI_MSK_3(0x0000FFC0,0x0000FFC0U, uint16_t  ))    /*  Read data burst size minus 1 */
...
#define REG_UART1_DIV                        0x40005428            /*  UART1 Baudrate Divider */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_UART_LSR_FIFOERR                 7            /*  data byte(s) in RX FIFO have either parity error, frame error or break indication. only used in 16550 mode; Read-clear if no more error in RX FIFO */
...
#define BITM_UART_LSR_FIFOERR                (_ADI_MSK_3(0x00000080,0x00000080U, uint16_t  ))    /*  data byte(s) in RX FIFO have either parity error, frame error or break indication. only used in 16550 mode; Read-clear if no more error in RX FIFO */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_UART_FCR_RFTRIG                  6            /*  RX FIFO Trig level */
...
#define BITM_UART_FCR_RFTRIG                 (_ADI_MSK_3(0x000000C0,0x000000C0U, uint16_t  ))    /*  RX FIFO Trig level */
...
#define ENUM_UART_CTL_EN000                  (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  RXINV: don't invert receiver line (idling high) */
#define ENUM_UART_CTL_EN001                  (_ADI_MSK_3(0x00000010,0x00000010U, uint16_t  ))    /*  RXINV: invert receiver line (idling low) */
...
#define BITP_UART_ASRL_BRKTO                  1            /*  Timed out due to long break condition */
...
#define BITM_UART_ASRL_BRKTO                 (_ADI_MSK_3(0x00000002,0x00000002U, uint16_t  ))    /*  Timed out due to long break condition */
...
#define BITM_BEEP_STAT_SEQREMAIN             (_ADI_MSK_3(0x000000FF,0x000000FFU, uint16_t  ))    /*  Remaining tone-pair sequence iterations to play in SEQ mode */
...
#define REG_ADC0_CH0_OUT                     0x40007030            /*  ADC0 Conversion Result Ch0 */
#define REG_ADC0_CH1_OUT                     0x40007034            /*  ADC0 Conversion Result Ch1 */
#define REG_ADC0_CH2_OUT                     0x40007038            /*  ADC0 Conversion Result Ch2 */
#define REG_ADC0_CH3_OUT                     0x4000703C            /*  ADC0 Conversion Result Ch3 */
#define REG_ADC0_CH4_OUT                     0x40007040            /*  ADC0 Conversion Result Ch4 */
#define REG_ADC0_CH5_OUT                     0x40007044            /*  ADC0 Conversion Result Ch5 */
#define REG_ADC0_CH6_OUT                     0x40007048            /*  ADC0 Conversion Result Ch6 */
#define REG_ADC0_CH7_OUT                     0x4000704C            /*  ADC0 Conversion Result Ch7 */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_ADC_CFG_VREFVBAT_DEL            10            /*  VREFBAT_DEL field must be set to 1 after minimum delay of 700us from VREFBAT field being set to 1. Note: VREFBAT_DEL and VREFBAT must be reset to 0 together. */
#define BITP_ADC_CFG_FAST_DISCH               9            /*  For fast switchover of vref from 2.5 to 1.25 */
#define BITP_ADC_CFG_TMPEN                    8            /*  To power up temperature sensor */
#define BITP_ADC_CFG_SINKEN                   7            /*  To enable additional 50uA sink current capability @1.25V, 100uA current capability @2.5V. */
...
#define BITP_ADC_CFG_VREFSEL                  1            /*  To select Vref as 1.25V or 2.5V */
#define BITP_ADC_CFG_PWRUP                    0            /*  Powering up ADC */
#define BITM_ADC_CFG_VREFVBAT_DEL            (_ADI_MSK_3(0x00000400,0x00000400U, uint16_t  ))    /*  VREFBAT_DEL field must be set to 1 after minimum delay of 700us from VREFBAT field being set to 1. Note: VREFBAT_DEL and VREFBAT must be reset to 0 together. */
#define BITM_ADC_CFG_FAST_DISCH              (_ADI_MSK_3(0x00000200,0x00000200U, uint16_t  ))    /*  For fast switchover of vref from 2.5 to 1.25 */
#define BITM_ADC_CFG_TMPEN                   (_ADI_MSK_3(0x00000100,0x00000100U, uint16_t  ))    /*  To power up temperature sensor */
#define BITM_ADC_CFG_SINKEN                  (_ADI_MSK_3(0x00000080,0x00000080U, uint16_t  ))    /*  To enable additional 50uA sink current capability @1.25V, 100uA current capability @2.5V. */
...
#define BITM_ADC_CFG_VREFSEL                 (_ADI_MSK_3(0x00000002,0x00000002U, uint16_t  ))    /*  To select Vref as 1.25V or 2.5V */
#define BITM_ADC_CFG_PWRUP                   (_ADI_MSK_3(0x00000001,0x00000001U, uint16_t  ))    /*  Powering up ADC */
#define ENUM_ADC_CFG_EN000                   (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  REFBUFEN: External reference is used */
#define ENUM_ADC_CFG_EN001                   (_ADI_MSK_3(0x00000004,0x00000004U, uint16_t  ))    /*  REFBUFEN: Reference buffer is enabled */
...
#define BITM_DMA_ALT_SET_CHAN                (_ADI_MSK_3(0x07FFFFFF,0x07FFFFFFUL, uint32_t  ))    /*  Control struct status / select alt struct */

/* -------------------------------------------------------------------------------------------------------------------------
          DMA_ALT_CLR                          Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_DMA_ALT_CLR_CHAN                 0            /*  Select primary data struct */
#define BITM_DMA_ALT_CLR_CHAN                (_ADI_MSK_3(0x07FFFFFF,0x07FFFFFFUL, uint32_t  ))    /*  Select primary data struct */
...
#define BITM_DMA_ERRCHNL_CLR_CHAN            (_ADI_MSK_3(0x07FFFFFF,0x07FFFFFFUL, uint32_t  ))    /*  Per channel Bus error status/ Per channel bus error clear */
...
#define BITM_DMA_INVALIDDESC_CLR_CHAN        (_ADI_MSK_3(0x07FFFFFF,0x07FFFFFFUL, uint32_t  ))    /*  Per channel Invalid Descriptor status/ Per channel Invalid descriptor status clear */
...
#define BITM_DMA_SRCADDR_SET_CHAN            (_ADI_MSK_3(0x07FFFFFF,0x07FFFFFFUL, uint32_t  ))    /*  Source Address decrement status / configure Source address decrement */
...
#define BITM_DMA_DSTADDR_SET_CHAN            (_ADI_MSK_3(0x07FFFFFF,0x07FFFFFFUL, uint32_t  ))    /*  Destination Address decrement status / configure destination address decrement */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_FLCC_STAT_ACCESS_MODE           31            /*  Indicates whether the controller is in Direct Access (default) or Indirect Access (servicing crypto commands) mode of operation */
...
#define BITM_FLCC_STAT_ACCESS_MODE           (_ADI_MSK_3(0x80000000,0x80000000UL, uint32_t  ))    /*  Indicates whether the controller is in Direct Access (default) or Indirect Access (servicing crypto commands) mode of operation */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_FLCC_KH_DATA0_VALUE              0            /*  Lower half of 64-bit dualword data to be written on a WRITE command */
#define BITM_FLCC_KH_DATA0_VALUE             (_ADI_MSK_3(0xFFFFFFFF,0xFFFFFFFFUL, uint32_t  ))    /*  Lower half of 64-bit dualword data to be written on a WRITE command */

/* -------------------------------------------------------------------------------------------------------------------------
          FLCC_KH_DATA1                        Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_FLCC_KH_DATA1_VALUE              0            /*  Upper half of 64-bit dualword data to be written on a WRITE command.
...
#define BITM_FLCC_KH_DATA1_VALUE             (_ADI_MSK_3(0xFFFFFFFF,0xFFFFFFFFUL, uint32_t  ))    /*  Upper half of 64-bit dualword data to be written on a WRITE command.
...
#define BITM_FLCC_CACHE_SETUP_ICEN           (_ADI_MSK_3(0x00000001,0x00000001UL, uint32_t  ))    /*  If this bit set, then I-Cache is enabled for AHB accesses. If 0, then I-cache is disabled, and all AHB accesses will be via Flash memory. This bit is cleared when Init bit is set. */
...
#define BITM_SPORT_CNVT_A_CNVT2FS            (_ADI_MSK_3(0x00FF0000,0x00FF0000UL, uint32_t  ))    /*  CONVT to FS duration: Half SPORT A */

#define BITM_SPORT_CNVT_A_POL                (_ADI_MSK_3(0x00000100,0x00000100UL, uint32_t  ))    /*  Polarity of the Convt signal */
#define BITM_SPORT_CNVT_A_WID                (_ADI_MSK_3(0x0000000F,0x0000000FUL, uint32_t  ))    /*  CONVT signal width: Half SPORT A */
...
#define BITM_SPORT_CNVT_B_CNVT2FS            (_ADI_MSK_3(0x00FF0000,0x00FF0000UL, uint32_t  ))    /*  CONVT to FS duration: Half SPORT B */

#define BITM_SPORT_CNVT_B_POL                (_ADI_MSK_3(0x00000100,0x00000100UL, uint32_t  ))    /*  Polarity of the Convt signal */
#define BITM_SPORT_CNVT_B_WID                (_ADI_MSK_3(0x0000000F,0x0000000FUL, uint32_t  ))    /*  CONVT signal width: Half SPORT B */
...
#define BITP_PMG_SRAMRET_RET4                 9            /*  Enable retention bank6 and bank7 (32kB) */
#define BITP_PMG_SRAMRET_RET3                 8            /*  Enable retention bank5 (32kB) */
#define BITP_PMG_SRAMRET_RET2                 1            /*  Enable retention bank 3 and bank 4 (32kB) */
#define BITP_PMG_SRAMRET_RET1                 0            /*  Enable retention bank 1 (12kB) */
...
#define BITM_PMG_SRAMRET_RET4                (_ADI_MSK_3(0x00000200,0x00000200UL, uint32_t  ))    /*  Enable retention bank6 and bank7 (32kB) */
#define BITM_PMG_SRAMRET_RET3                (_ADI_MSK_3(0x00000100,0x00000100UL, uint32_t  ))    /*  Enable retention bank5 (32kB) */
#define BITM_PMG_SRAMRET_RET2                (_ADI_MSK_3(0x00000002,0x00000002UL, uint32_t  ))    /*  Enable retention bank 3 and bank 4 (32kB) */
#define BITM_PMG_SRAMRET_RET1                (_ADI_MSK_3(0x00000001,0x00000001UL, uint32_t  ))    /*  Enable retention bank 1 (12kB) */
...
#define ENUM_PMG_CTL1_LOWPWRDISABLE          (_ADI_MSK_3(0x00000000,0x00000000UL, uint32_t  ))    /*  HPBUCK_LOWPWR_MODE: HPBUCK Low power mode is disabled, When LOW */
#define ENUM_PMG_CTL1_LOWPWRENABLE           (_ADI_MSK_3(0x00000004,0x00000004UL, uint32_t  ))    /*  HPBUCK_LOWPWR_MODE: HPBUCK Low power mode is enabled, When HIGH */
...
#define BITP_CLKG_OSC_CTL_ROOT_AUTSW_STA     22            /*  Status of automatic switching of the Root clock to HF OSC upon detection of Root clock failure */
...
#define BITP_CLKG_OSC_CTL_LFX_AUTSW_STA      13            /*  Status of automatic switching of the LF Mux to LF OSC upon detection of LF XTAL failure */
#define BITP_CLKG_OSC_CTL_LFX_AUTSW_EN       12            /*  Enables automatic Switching of the LF Mux to LF OSC on LF XTAL Failure */
...
#define BITM_CLKG_OSC_CTL_ROOT_AUTSW_STA     (_ADI_MSK_3(0x00400000,0x00400000UL, uint32_t  ))    /*  Status of automatic switching of the Root clock to HF OSC upon detection of Root clock failure */
...
#define BITM_CLKG_OSC_CTL_LFX_AUTSW_STA      (_ADI_MSK_3(0x00002000,0x00002000UL, uint32_t  ))    /*  Status of automatic switching of the LF Mux to LF OSC upon detection of LF XTAL failure */

#define BITM_CLKG_OSC_CTL_LFX_AUTSW_EN       (_ADI_MSK_3(0x00001000,0x00001000UL, uint32_t  ))    /*  Enables automatic Switching of the LF Mux to LF OSC on LF XTAL Failure */
...
#define REG_PMG0_TST_FAST_SHT_WAKEUP         0x4004C274            /*  PMG0_TST Fast shutdown wakeup enable */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_PMG_TST_FAST_SHT_WAKEUP_FAST_SHT_WAKEUP  0            /*  Enables fast shutdown wakeup */

#define BITM_PMG_TST_FAST_SHT_WAKEUP_FAST_SHT_WAKEUP (_ADI_MSK_3(0x00000001,0x00000001UL, uint32_t  ))    /*  Enables fast shutdown wakeup */
...
#define INTR_UART0_EVTn                       14		/* Event */
...
#define INTR_UART1_EVTn                       66		/* Event */
