...
* and a sample and hold circuit. The high level features are:
*
...
*   - Works as a buffer, amplifier, or sample-and-hold for the CTDAC output
...
* The output stage can operate as a low-drive strength Opamp (1X), a high-drive strength
* Opamp (10X), or a comparator.
*
...
*
* \image html ctb_block_diagram.png
* \image latex ctb_block_diagram.png
*
* \section group_ctb_init Initialization
*
...
*
* The CTB has a sample and hold (S/H) circuit at the non-inverting input of Opamp0.
...
* If the S/H circuit is used for the CTDAC, the \ref Cy_CTB_DACSampleAndHold function
* should be called.
*
...
*   <tr><th>Opamp Power</th><th>Pump Clock Freq</th></tr>
*   <tr>
*     <td>Low or Medium</td>
*     <td>8 - 24 MHz</td>
*   </tr>
...
*
* <b>Reference Current Configurations</b>
*
...
*
* <b>Sample and Hold Switch Control</b>
*
* The following eight switches that are contained in the CTB are enabled by the CTDAC IP
* block:
*
*   - COS, CA0, CHD, CH6, COB, COR, CRS and CRD
*
* If any of the above switches are used, the \ref Cy_CTDAC_Enable function must be called.
* Additionally, if any of the switches are used in Deep Sleep mode, the CTDAC must also
* be configured to operate in Deep Sleep (see \ref Cy_CTDAC_SetDeepSleepMode).
*
* \section group_ctb_code_example Complete Code Example
*
* The following example code demonstrates how to configure Opamp0
* as a comparator and Opamp1 as a voltage follower. The terminals
...
* The \ref Cy_CTB_SetInterruptMask function can be called with CY_CTB_OPAMP_NONE
...
*/
typedef enum {
    CY_CTB_MODE_OPAMP1X    = 0u,                                               /**< Configure Opamp for low drive strength (1x) */
    CY_CTB_MODE_OPAMP10X   = 1u << CTBM_OA_RES0_CTRL_OA0_DRIVE_STR_SEL_Pos,    /**< Configure Opamp high drive strength (10x) */
...
/**
* Switch masks for CTDAC routing to be used in \ref Cy_CTB_SetAnalogSwitch.
*
...
typedef enum
{
    CY_CTB_SW_CTD_REF_OA1_OUT_MASK              = CTBM_CTD_SW_CTDD_CRD_Msk,       /**< Switch CRD: Opamp1 output to CTDAC reference. <b>CTDAC must be enabled</b> */
    CY_CTB_SW_CTD_REFSENSE_OA1_NEG_MASK         = CTBM_CTD_SW_CTDS_CRS_Msk,       /**< Switch CRS: CTDAC reference sense to Opamp1 inverting input. <b>CTDAC must be enabled</b> */
    CY_CTB_SW_CTD_OUT_OA1_NEG_MASK              = CTBM_CTD_SW_CTDS_COR_Msk,       /**< Switch COR: CTDAC output to Opamp1 inverting input. <b>CTDAC must be enabled</b> */
    CY_CTB_SW_CTD_OUT_PIN6_MASK                 = CTBM_CTD_SW_CTDO_C6H_Msk,       /**< Switch C6H: CTDAC output to P6 of CTB device port. <b>CTDAC must be enabled</b> */
    CY_CTB_SW_CTD_OUT_CHOLD_MASK                = CTBM_CTD_SW_CTDO_COS_Msk,       /**< Switch COS: CTDAC output to hold cap (deglitch capable). <b>CTDAC must be enabled</b> */
    CY_CTB_SW_CTD_OUT_OA0_1X_OUT_MASK           = CTBM_CTD_SW_CTDH_COB_Msk,       /**< Switch COB: Drive CTDAC output with opamp0 1x output during hold mode. <b>CTDAC must be enabled</b> */
    CY_CTB_SW_CTD_CHOLD_CONNECT_MASK            = CTBM_CTD_SW_CTDH_CHD_Msk,       /**< Switch CHD: Hold cap connection. <b>CTDAC must be enabled</b> */
    CY_CTB_SW_CTD_CHOLD_OA0_POS_MASK            = CTBM_CTD_SW_CTDH_CA0_Msk,       /**< Switch CA0: Hold cap to Opamp0 non-inverting input. <b>CTDAC must be enabled</b> */
...
*
* -# Call \ref Cy_CTB_DACSampleAndHold with CY_CTB_SH_PREPARE_SAMPLE or CY_CTB_SH_PREPARE_HOLD
* -# Enable or disable CTDAC output
* -# Call \ref Cy_CTB_DACSampleAndHold with CY_CTB_SH_SAMPLE or CY_CTB_SH_HOLD
*/
typedef enum
{
...
*/
typedef struct {
    cy_en_ctb_deep_sleep_t      deepSleep;      /**< Enable or disable the CTDAC during Deep Sleep */
...
*   - .oa0CompLevel  = CY_CTB_COMP_DSI_TRIGGER_OUT_PULSE
...
*   - .oa1CompLevel  = CY_CTB_COMP_DSI_TRIGGER_OUT_PULSE
...
__STATIC_INLINE void Cy_CTB_SetSwInterrupt(CTBM_Type *base, cy_en_ctb_opamp_sel_t compNum);
...
****************************************************************************//**
*
* Powers up the hardware block necessary for the operation of the CTB.
*
* \param base
...
****************************************************************************//**
*
* Powers down the hardware block necessary for the operation of the CTB.
*
* \param base
* Pointer to structure describing registers
*
...
****************************************************************************//**
*
* Returns status of the interrupt that happens when the configured comparator
* edge is detected.
*
* \param base
* Pointer to structure describing registers
...
/*******************************************************************************
* Function Name: Cy_CTB_SetSwInterrupt
****************************************************************************//**
*
...
*
* \param compNum
* CY_CTB_OPAMP_NONE, CY_CTB_OPAMP_0, CY_CTB_OPAMP_1, or CY_CTB_OPAMP_BOTH
*
...
* 0 - Edge not detected or not masked
...
****************************************************************************//**
*
* Set the IPTAT level to 1uA or 100nA. The IPTAT generator is used by the CTB
...
****************************************************************************//**
*
* Set the clock source for the CTB charge pump. The clock can come from:
...
*
* \param clkPump
* Value from enum \ref cy_en_ctb_clk_pump_source_t
*
* \return None
*
*******************************************************************************/
...
*
* Without the IPTAT reference, the CTB cannot compensate for the slope of
