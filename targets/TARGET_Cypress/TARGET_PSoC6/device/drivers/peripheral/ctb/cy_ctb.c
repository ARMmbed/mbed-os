...
****************************************************************************//**
*
* Initializes or restores the CTB and both Opamps according to the
...
*
* \param opampNum
* CY_CTB_OPAMP_0, CY_CTB_OPAMP_1, or CY_CTB_OPAMP_BOTH
*
* \param config
* Pointer to structure containing configuration data
*
...
****************************************************************************//**
*
* Initializes each Opamp of the CTB to one of the common use modes.
...
* of Opamp0. Use one of the provided structures or define your own.
...
* \param config1
* Pointer to structure containing configuration data for quick initialization
* of Opamp1. Use one of the provided structures or define your own.
...
cy_en_ctb_status_t Cy_CTB_FastInit(CTBM_Type *base, const cy_stc_ctb_fast_config_oa0_t *config0, const cy_stc_ctb_fast_config_oa1_t *config1)
{
    ...
    else
    {
        ...
        base->OA_RES0_CTRL = (uint32_t) config0->oa0Power \
                             ...
                             | (uint32_t) CY_CTB_COMP_DSI_TRIGGER_OUT_PULSE \
...
****************************************************************************//**
*
* High level API function for configuring the current modes of the Opamps.
* This API configures all Opamps of the CTB to the same current mode.
* These modes are differentiated by the IPTAT current level, the Opamp
...
*
* \param currentMode
* Enable or disable CTB in Deep Sleep.
*
* \return None
*
*******************************************************************************/
...
****************************************************************************//**
*
* Sets whether to allow the CTB to continue to stay powered in Deep Sleep mode.
*
...
* range is reduced to 0 - VDDA-1.5 V.
*
* \param base
* Pointer to structure describing registers
*
...
****************************************************************************//**
*
* Sets the Opamp output mode to 1x drive, 10x drive, or comparator mode.
*
* \param base
* Pointer to structure describing registers
*
...
****************************************************************************//**
*
* Sets the Opamp power mode to one of three levels to trade off power for
* gain bandwidth. Also enable or disable voltage pump to increase input
* range to supply rails.
*
* \param base
* Pointer to structure describing registers
*
...
*
* \param pump
* Enable or disable the charge pump for increased input range
*
* \return None
*
*******************************************************************************/
...
****************************************************************************//**
*
* Performs sampling and holding of the CTDAC output.
...
*
* \param opampNum
* CY_CTB_OPAMP_0 or CY_CTB_OPAMP_1
*
...
****************************************************************************//**
*
* Returns the current CTB Opamp slope trim value.
*
* \param base
* Pointer to structure describing registers
*
...
*
* \param state
* CY_CTB_SWITCH_OPEN or CY_CTB_SWITCH_CLOSE
*
...
****************************************************************************//**
*
* Configures the CTB comparator for pulse or level output, to bypass clock
...
****************************************************************************//**
*
* Returns the CTB comparator operating configuration.
*
* \param base
* Pointer to structure describing registers
*
...
****************************************************************************//**
*
* Configures the type of edge that will trigger a comparator interrupt.
*
* \param base
* Pointer to structure describing registers
*
...
****************************************************************************//**
*
* Returns status of the indicated comparator output.
*
* \param base
* Pointer to structure describing registers
*
...
*
* A value of 0 is returned if compNum is an invalid value, CY_CTB_OPAMP_NONE
