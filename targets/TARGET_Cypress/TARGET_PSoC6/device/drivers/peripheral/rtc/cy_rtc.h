...
* from Hibernate mode.
*
* * The Internal Low-speed Oscillator (ILO) routed from LFClk or directly 
...
* DeepSleep mode the ILO is routed through LFClk. But for Hibernate
* power mode the ILO is set directly. Note that, the ILO should be configured to
* work in the Hibernate mode. For more info refer to the System Clock 
* (sysclk) driver. The ILO is a low-accuracy RC-oscillator that does not require
...
*
* * The Precision Internal Low-speed Oscillator (PILO), routed from LFClk 
...
* Do not route the WCO through the LFClk. This is because LFClk is not available
* in all low-power modes.
*
...
#define CY_RTC_DRV_VERSION_MINOR                    0
/** \} group_rtc_macros */
