...
#include "system_CMSDK_BEETLE.h"              /* System Header                                   */
...
*************************************************************************/
/* GPIO 2 */
#define CORDIO_LLCCTRL_RESETX_BIT                         (1<<0)
#define CORDIO_LLCCTRL_SYSTEM_RESET_BIT                   (1<<1)
#define CORDIO_LLCCTRL_LLC_RESET_BIT                      (1<<2)
#define CORDIO_LLCCTRL_WAKE_REQ_BIT                       (1<<3)
#define CORDIO_LLCCTRL_SLEEP_REQ_BIT                      (1<<4)
#define CORDIO_LLCCTRL_SWITCHING_REGULATOR_REQUEST_BIT    (1<<5)
#define CORDIO_LLCCTRL_BATTERY_STATUS_REQUEST_BIT         (1<<6)
#define CORDIO_LLCCTRL_32M_XTAL_REQUEST_BIT               (1<<7)

/* GPIO 3  */
#define CORDIO_LLCCTRL_VMEM_ON_BIT                        ((1<<10) | (1 << 11))

/*********************************************************************
*        GPIO 2 / 3 BIT FEILD POS, INPUTS
*************************************************************************/

#define CORDIO_LLCCTRL_RESET_SYNDROME_MSK                 (3<<0)

#define CORDIO_LLCCTRL_STATUS_ACTIVE_32KXTAL_BIT          (1<<2)
#define CORDIO_LLCCTRL_STATUS_ACTIVE_32MXTAL_BIT          (1<<3)

#define CORDIO_LLCCTRL_STATUS_BATTERY_DET3V_BIT           (1<<4)
#define CORDIO_LLCCTRL_STATUS_BATTERY_STATUS_BIT          (1<<5)
#define CORDIO_LLCCTRL_STATUS_V1V_ON_STATUS_BIT           (1<<6)
#define CORDIO_LLCCTRL_STATUS_AWAKE_BIT                   (1<<7)

/**************************************************************/
// RESET LOW
#define CORDIO_LLCCTRL_RESETX_ASSERT()       (CMSDK_GPIO2->DATAOUT &=~CORDIO_LLCCTRL_RESETX_BIT)
#define CORDIO_LLCCTRL_RESETX_NEGATE()       (CMSDK_GPIO2->DATAOUT |= CORDIO_LLCCTRL_RESETX_BIT)
// RESET HIGH
#define CORDIO_LLCCTRL_SYSTEM_RESET_ASSERT() (CMSDK_GPIO2->DATAOUT |=CORDIO_LLCCTRL_SYSTEM_RESET_BIT)
#define CORDIO_LLCCTRL_SYSTEM_RESET_NEGATE() (CMSDK_GPIO2->DATAOUT &=~CORDIO_LLCCTRL_SYSTEM_RESET_BIT)

// RESET HIGH
#define CORDIO_LLCCTRL_LLC_RESET_ASSERT()    (CMSDK_GPIO2->DATAOUT |=CORDIO_LLCCTRL_LLC_RESET_BIT)
#define CORDIO_LLCCTRL_LLC_RESET_NEGATE()    (CMSDK_GPIO2->DATAOUT &=~CORDIO_LLCCTRL_LLC_RESET_BIT)

// ACTIVE HIGH
#define CORDIO_LLCCTRL_WAKE_REQ_ASSERT()     (CMSDK_GPIO2->DATAOUT |=CORDIO_LLCCTRL_WAKE_REQ_BIT)
#define CORDIO_LLCCTRL_WAKE_REQ_NEGATE()     (CMSDK_GPIO2->DATAOUT &=~CORDIO_LLCCTRL_WAKE_REQ_BIT)

// ACTIVE HIGH
#define CORDIO_LLCCTRL_SLEEP_REQ_ASSERT()    (CMSDK_GPIO2->DATAOUT |=CORDIO_LLCCTRL_SLEEP_REQ_BIT)
#define CORDIO_LLCCTRL_SLEEP_REQ_NEGATE()    (CMSDK_GPIO2->DATAOUT &=~CORDIO_LLCCTRL_SLEEP_REQ_BIT)

// ACTIVE HIGH
#define CORDIO_LLCCTRL_SWITCHING_REGULATOR_REQUEST_ASSERT() (CMSDK_GPIO2->DATAOUT |=CORDIO_LLCCTRL_SWITCHING_REGULATOR_REQUEST_BIT)
#define CORDIO_LLCCTRL_SWITCHING_REGULATOR_REQUEST_NEGATE() (CMSDK_GPIO2->DATAOUT &=~CORDIO_LLCCTRL_SWITCHING_REGULATOR_REQUEST_BIT)
// ACTIVE HIGH
#define CORDIO_LLCCTRL_BATTERY_STATUS_REQUEST_ASSERT()      (CMSDK_GPIO2->DATAOUT |=CORDIO_LLCCTRL_BATTERY_STATUS_REQUEST_BIT)
#define CORDIO_LLCCTRL_BATTERY_STATUS_REQUEST_NEGATE()      (CMSDK_GPIO2->DATAOUT &=~CORDIO_LLCCTRL_BATTERY_STATUS_REQUEST_BIT)

// ACTIVE HIGH
#define CORDIO_LLCCTRL_32M_XTAL_REQUEST_ASSERT()            (CMSDK_GPIO2->DATAOUT |=CORDIO_LLCCTRL_32M_XTAL_REQUEST_BIT)
#define CORDIO_LLCCTRL_32M_XTAL_REQUEST_NEGATE()            (CMSDK_GPIO2->DATAOUT &=~CORDIO_LLCCTRL_32M_XTAL_REQUEST_BIT)
// ASSERTS HIGH
#define CORDIO_LLCCTRL_VMEM_ON_ASSERT()                     (CMSDK_GPIO3->DATAOUT |=CORDIO_LLCCTRL_VMEM_ON_BIT)
#define CORDIO_LLCCTRL_VMEM_ON_NEGATE()                     (CMSDK_GPIO3->DATAOUT &=~CORDIO_LLCCTRL_VMEM_ON_BIT)


/************ READ STATUS ********************/

// ACTIVE HIGH, BIT INDEPANDENT
#define CORDIO_LLCCTRL_RESET_SYNDROME_GET()                 (CMSDK_GPIO2->DATA & CORDIO_LLCCTRL_RESET_SYNDROME_MSK)
// ACTIVE HIGH
#define CORDIO_LLCCTRL_STATUS_ACTIVE_32KXTAL_GET()          (CMSDK_GPIO2->DATA & CORDIO_LLCCTRL_STATUS_ACTIVE_32KXTAL_BIT)
// ACTIVE HIGH
#define CORDIO_LLCCTRL_STATUS_ACTIVE_32MXTAL_GET()          (CMSDK_GPIO2->DATA & CORDIO_LLCCTRL_STATUS_ACTIVE_32MXTAL_BIT)
// ACTIVE HIGH
#define CORDIO_LLCCTRL_STATUS_BATTERY_DET3V_GET()           (CMSDK_GPIO2->DATA & CORDIO_LLCCTRL_STATUS_BATTERY_DET3V_BIT)
// ACTIVE HIGH
#define CORDIO_LLCCTRL_STATUS_BATTERY_STATUS_GET()          (CMSDK_GPIO2->DATA & CORDIO_LLCCTRL_STATUS_BATTERY_STATUS_BIT)
// ACTIVE HIGH
#define CORDIO_LLCCTRL_STATUS_V1V_ON_STATUS_GET()           (CMSDK_GPIO2->DATA & CORDIO_LLCCTRL_STATUS_V1V_ON_STATUS_BIT)
// ACTIVE HIGH
#define CORDIO_LLCCTRL_STATUS_AWAKE_GET()                   (CMSDK_GPIO2->DATA & CORDIO_LLCCTRL_STATUS_AWAKE_BIT)


/* ---- DEBUG MASK & VALUE BITs used for diagnosis  ---- */
#define INSTALL_DEBUG__GPIO_TOGGLES

#ifdef INSTALL_DEBUG__GPIO_TOGGLES

#define GPIO_TOGGLES_MSK        (0xFC)
...
#define BIT_SET(B)            (CMSDK_GPIO0->DATAOUT |= ((B) & (GPIO_TOGGLES_MSK)))

#define BIT_CLR(B)            (CMSDK_GPIO0->DATAOUT &= ~((B) & (GPIO_TOGGLES_MSK)))

/* BIT TOGGLE, XOR */
#define BIT_TGL(B)            (CMSDK_GPIO0->DATAOUT ^= ((B) & (GPIO_TOGGLES_MSK)))
