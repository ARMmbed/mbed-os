...
void uart0_irq()
{
    uart_irq(CMSDK_UART1->INTSTATUS & 0x3, 0, (CMSDK_UART_TypeDef *)CMSDK_UART1);
}
void uart1_irq()
{
    uart_irq(CMSDK_UART3->INTSTATUS & 0x3, 1, (CMSDK_UART_TypeDef *)CMSDK_UART3);
}
void uart2_irq()
{
    uart_irq(CMSDK_UART0->INTSTATUS & 0x3, 2, (CMSDK_UART_TypeDef *)CMSDK_UART0);
}
void uart3_irq()
{
    uart_irq(CMSDK_UART2->INTSTATUS & 0x3, 3, (CMSDK_UART_TypeDef *)CMSDK_UART2);
}
