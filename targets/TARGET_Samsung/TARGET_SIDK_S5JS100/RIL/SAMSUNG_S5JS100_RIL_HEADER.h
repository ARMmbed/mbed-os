...
/*
 * RIL_REQUEST_SET_PDN_IP_ADDR
 *
 * "data" is const char **
 * ((const char**)data)[0] = "rmnet1", "rmnet2", "rmnet3", "rmnet4"
 * ((const char**)data)[1] = "IP", "IPV6", "IPV4V6"
 * ((const char**)data)[2] = IPV4 PDP address (Byte array format, size 4bytes)
 * ((const char**)data)[3] = IPV6 PDP address (Byte array format, size 16bytes)
 * "response" is NULL
 *
 * Valid errors:
 *  SUCCESS
 *  GENERIC_FAILURE
 */
#define RIL_REQUEST_SET_PDN_IP_ADDR  (RIL_REQUEST_EXTENSION_BASE+7)
 ...
 * RADIO_NOT_AVAILABLE
 */
#define RIL_REQUEST_SET_DEBUG_TRACE (RIL_REQUEST_EXTENSION_BASE+8)
/*
 * RIL_REQUEST_SET_DEBUG_TRACE
 *
 * "data" is int
 *
 * "response" is NULL
