...
private:
    ...
    int envelope_data_available(unsigned char channel_status0, unsigned char channel_status1, unsigned int receive_data_length);
...
public:
    ...
    void RegisterRspCB(void (*cb)(void *msg, unsigned int msglen))
    {
        rsp_cb = cb;
    }
