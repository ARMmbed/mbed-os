...
#define BOOTARG_VAL_OFFSET	0x20
#define BOOTARG_VAL_MAX_SIZE	0x20
void sflash_os_env_parser(void)
{
	char *env_addr, *ptr;
	int argc = 0;
	char buf[4096];
	env_addr = (char *)(S5JS100_FLASH_PADDR + S5JS100_OS_ENV_OFFSET+BOOTARG_VAL_OFFSET);
...
#if 0
		if(memcmp((void*)0x4086A000+flash_idx, (void*)addr, size)) {
