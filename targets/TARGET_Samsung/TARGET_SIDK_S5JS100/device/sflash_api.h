...
#define S5JS100_FLASH_FS_PADDR          MBED_CONF_FLASHIAP_BLOCK_DEVICE_BASE_ADDRESS
#define S5JS100_FLASH_SIZE              (16 * 1024 * 1024)
#define S5JS100_FLASH_FS_SIZE           (0x005DA000) //5992KB 
#define S5JS100_OS_ENV_OFFSET			(0x2E000)
