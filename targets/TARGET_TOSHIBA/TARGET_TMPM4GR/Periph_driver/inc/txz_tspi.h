...
/**
 *  @defgroup TSPI_Infinity_Control Frame infinity Control
 *  @brief    Frame infinity Enable/Disable Macro Definition.
 *  @{
 */
...
/**
 *  @}
 */ /* End of group TSPI_Infinity_Control */
 ...
 *  @{
 */
#define TSPI_RXDLY_1CLK                 ((uint32_t)0x00000000)    /*!< RXDLY 1CLK      */
#define TSPI_RXDLY_2CLK                 ((uint32_t)0x00010000)    /*!< RXDLY 2CLK      */
#define TSPI_RXDLY_3CLK                 ((uint32_t)0x00020000)    /*!< RXDLY 3CLK      */
#define TSPI_RXDLY_4CLK                 ((uint32_t)0x00030000)    /*!< RXDLY 4CLK      */
#define TSPI_RXDLY_5CLK                 ((uint32_t)0x00040000)    /*!< RXDLY 5CLK      */
#define TSPI_RXDLY_6CLK                 ((uint32_t)0x00050000)    /*!< RXDLY 6CLK      */
#define TSPI_RXDLY_7CLK                 ((uint32_t)0x00060000)    /*!< RXDLY 7CLK      */
#define TSPI_RXDLY_8CLK                 ((uint32_t)0x00070000)    /*!< RXDLY 8CLK      */
/**
 *  @}
...
/**
 *  @defgroup TSPI_SECT_MODE  Sect mode setting
 *  @brief    Sect mode Macro Definition.
 *  @{
 */
#define TSPI_SECT_MODE_FRAME           ((uint32_t)0x00000000)    /*!< Frame Mode  */
#define TSPI_SECT_MODE_SECT            ((uint32_t)0x00000001)    /*!< Sect Mode   */
/**
 *  @}
 */ /* End of group TSPI_SECT_MODE */


/**
 *  @defgroup TSPI_SECT_VALUE  Sect bit length setting
 *  @brief    Sect bit length Macro Definition.
 *  @{
 */
#define TSPI_SECT_VALUE_0              ((uint32_t)0x00000000)    /*!< length:0    */
#define TSPI_SECT_VALUE_1              ((uint32_t)0x00000001)    /*!< length:1    */
#define TSPI_SECT_VALUE_MAX            ((uint32_t)0x00000020)    /*!< MAX:32      */
/**
 *  @}
 */ /* End of group TSPI_SECT_VALUE */
...
/*----------------------------------*/
typedef struct {
    uint32_t sect;        /*!< Sect mode settings.
                                : Use @ref TSPI_SECT_MODE */
} tspi_sectcr0_t;
...
/*----------------------------------*/
typedef struct {
    uint32_t sectl3;      /*!< SECTL3 Bit length setting.
                                : Use @ref TSPI_SECT_VALUE  */
    uint32_t sectl2;      /*!< SECTL2 Bit length setting.
                                : Use @ref TSPI_SECT_VALUE  */
    uint32_t sectl1;      /*!< SECTL1 Bit length setting.
                                : Use @ref TSPI_SECT_VALUE  */
    uint32_t sectl0;      /*!< SECTL0 Bit length setting.
                                : Use @ref TSPI_SECT_VALUE  */
} tspi_sectcr1_t;
...
typedef struct {
    ...
    tspi_sectcr0_t  scr0;   /*!< Sect control0 setting.
                                    : Use @ref tspi_sectcr0_t  */
    tspi_sectcr1_t  scr1;   /*!< Sect control1 setting.
