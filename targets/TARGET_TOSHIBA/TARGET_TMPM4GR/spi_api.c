...
static const spi_irq_t SPI_CH5_IRQN_TBL[1] = {
    { INTT5RX_IRQn, INTT5TX_IRQn, INTT5ERR_IRQn }
};
static const spi_irq_t SPI_CH6_IRQN_TBL[1] = {
    { INTT6RX_IRQn, INTT6TX_IRQn, INTT6ERR_IRQn }
};
static const spi_irq_t SPI_CH7_IRQN_TBL[1] = {
    { INTT7RX_IRQn, INTT7TX_IRQn, INTT7ERR_IRQn }
};
static const spi_irq_t SPI_CH8_IRQN_TBL[1] = {
    { INTT8RX_IRQn, INTT8TX_IRQn, INTT8ERR_IRQn }
};
#endif
...
void spi_init(spi_t *obj, PinName mosi, PinName miso, PinName sclk, PinName ssel)
{
...
#if DEVICE_SPI_ASYNCH
            obj_s->irqn = (uint32_t)&SPI_CH1_IRQN_TBL;
#endif
            break;
        case SPI_2:
...
#if DEVICE_SPI_ASYNCH
            obj_s->irqn = (uint32_t)&SPI_CH3_IRQN_TBL;
#endif
            break;
        case SPI_4:
...
#if DEVICE_SPI_ASYNCH
            obj_s->irqn = (uint32_t)&SPI_CH4_IRQN_TBL;
#endif
            break;
        case SPI_5:
...
#if DEVICE_SPI_ASYNCH
            obj_s->irqn = (uint32_t)&SPI_CH5_IRQN_TBL;
#endif
            break;
        case SPI_6:
...
#if DEVICE_SPI_ASYNCH
            obj_s->irqn = (uint32_t)&SPI_CH6_IRQN_TBL;
#endif
            break;
        case SPI_7:
            ...
            TSB_CG_FSYSMENB_IPMENB13 = TXZ_ENABLE;
#if DEVICE_SPI_ASYNCH
            obj_s->irqn = (uint32_t)&SPI_CH7_IRQN_TBL;
#endif
            break;
        case SPI_8:
...
#if DEVICE_SPI_ASYNCH
            obj_s->irqn = (uint32_t)&SPI_CH8_IRQN_TBL;
#endif
            break;
        default:
    ...
    spi_frequency(obj_s, (int)INITIAL_SPI_FREQ);
