...
/*------------------------------------------------------------------------------*/
#ifndef __GPIO_M4NR_H
#define __GPIO_M4NR_H
...
#define GPIO_PORT_A_2   (0x3F17)
#define GPIO_PORT_A_3   (0x3DDF)
#define GPIO_PORT_A_4   (0x3DDF)
#define GPIO_PORT_A_5   (0x3DD7)
#define GPIO_PORT_A_6   (0x3F97)
#define GPIO_PORT_A_7   (0x3DDF)
/* PortB */
#define GPIO_PORT_B_0   (0x3CFF)
#define GPIO_PORT_B_1   (0x3CDF)
#define GPIO_PORT_B_2   (0x3CD7)
#define GPIO_PORT_B_3   (0x3C97)
#define GPIO_PORT_B_4   (0x0000)
#define GPIO_PORT_B_5   (0x0000)
#define GPIO_PORT_B_6   (0x0000)
#define GPIO_PORT_B_7   (0x0000)
/* PortC */
#define GPIO_PORT_C_0   (0x0000)
#define GPIO_PORT_C_1   (0x0000)
#define GPIO_PORT_C_2   (0x0000)
#define GPIO_PORT_C_3   (0x0000)
...
/* PortE */
#define GPIO_PORT_E_0   (0x3FFF)
#define GPIO_PORT_E_1   (0x3FF7)
#define GPIO_PORT_E_2   (0x3FF7)
#define GPIO_PORT_E_3   (0x3FF7)
...
#define GPIO_PORT_F_5   (0x3C87)
#define GPIO_PORT_F_6   (0x3C87)
#define GPIO_PORT_F_7   (0x3CE7)
/* PortG */
#define GPIO_PORT_G_0   (0x3E57)
#define GPIO_PORT_G_1   (0x3E57)
#define GPIO_PORT_G_2   (0x3FF3)
#define GPIO_PORT_G_3   (0x3FF3)
#define GPIO_PORT_G_4   (0x3FEB)
#define GPIO_PORT_G_5   (0x3FFB)
#define GPIO_PORT_G_6   (0x3CE7)
#define GPIO_PORT_G_7   (0x3E67)
/* PortH */
#define GPIO_PORT_H_0   (0x3E77)
...
/* PortK */
#define GPIO_PORT_K_0   (0x3E9F)
#define GPIO_PORT_K_1   (0x3CFF)
#define GPIO_PORT_K_2   (0x3E87)
#define GPIO_PORT_K_3   (0x3E87)
#define GPIO_PORT_K_4   (0x3EA7)
#define GPIO_PORT_K_5   (0x3EA7)
#define GPIO_PORT_K_6   (0x3EBF)
#define GPIO_PORT_K_7   (0x3FBB)
/* PortL */
#define GPIO_PORT_L_0   (0x3FDB)
#define GPIO_PORT_L_1   (0x3F43)
#define GPIO_PORT_L_2   (0x3F43)
#define GPIO_PORT_L_3   (0x3FDB)
#define GPIO_PORT_L_4   (0x3C1B)
#define GPIO_PORT_L_5   (0x3C0B)
#define GPIO_PORT_L_6   (0x3C1B)
#define GPIO_PORT_L_7   (0x3C0F)
/* PortM */
#define GPIO_PORT_M_0   (0x3FE7)
#define GPIO_PORT_M_1   (0x3FF7)
#define GPIO_PORT_M_2   (0x3FDB)
#define GPIO_PORT_M_3   (0x3FEB)
...
#define GPIO_PORT_T_4   (0x3E03)
#define GPIO_PORT_T_5   (0x3C0B)
#define GPIO_PORT_T_6   (0x0000)
#define GPIO_PORT_T_7   (0x0000)
/* PortU */
#define GPIO_PORT_U_0   (0x3D5B)
#define GPIO_PORT_U_1   (0x0000)
#define GPIO_PORT_U_2   (0x3D9B)
#define GPIO_PORT_U_3   (0x3DDB)
#define GPIO_PORT_U_4   (0x3D9B)
#define GPIO_PORT_U_5   (0x3D9B)
#define GPIO_PORT_U_6   (0x3F9B)
#define GPIO_PORT_U_7   (0x3F8B)
/* PortV */
#define GPIO_PORT_V_0   (0x3FDB)
#define GPIO_PORT_V_1   (0x3FDB)
#define GPIO_PORT_V_2   (0x3FDB)
#define GPIO_PORT_V_3   (0x3FCB)
#define GPIO_PORT_V_4   (0x3FEF)
#define GPIO_PORT_V_5   (0x3FFF)
...
#define INIT_GPIO_PORT_A_FR8(var)   ((var) = 0x00)
...
#define INIT_GPIO_PORT_C_FR4(var)
...
#define INIT_GPIO_PORT_G_FR8(var)   ((var) = 0x00)
...
#define INIT_GPIO_PORT_H_FR8(var)   ((var) = 0x00)
...
#define INIT_GPIO_PORT_K_FR8(var)   ((var) = 0x00)
...
#define INIT_GPIO_PORT_L_FR8(var)   ((var) = 0x00)
...
#define INIT_GPIO_PORT_M_FR8(var)   ((var) = 0x00)
...
#define INIT_GPIO_PORT_T_FR8(var)   ((var) = 0x00)
...
#define INIT_GPIO_PORT_U_FR5(var)   ((var) = 0x00)
#define INIT_GPIO_PORT_U_FR6(var)   ((var) = 0x00)
#define INIT_GPIO_PORT_U_FR7(var)   ((var) = 0x00)
#define INIT_GPIO_PORT_U_FR8(var)   ((var) = 0x00)
...
#define INIT_GPIO_PORT_V_FR8(var)   ((var) = 0x00)
...
#define INIT_GPIO_PORT_Y_FR6(var)   ((var) = 0x00)
...
typedef enum {
    ...
    GPIO_PA2_EMAPPSOUT0 = GPIO_FR_8, /*!< PAFR8: EMAPPSOUT0     */
} gpio_pa2_func_t;
...
typedef enum {
    ...
    GPIO_PA6_EMAPPSOUT1 = GPIO_FR_8, /*!< PAFR8: EMAPPSOUT1     */
} gpio_pa6_func_t;
...
typedef enum {
    ...
    GPIO_PB0_USB_ECLK   = GPIO_FR_6, /*!< PBFR6: USB_ECLK       */
} gpio_pb0_func_t;
...
typedef enum {
    ...
    GPIO_PB2_USBA_VBUSEN = GPIO_FR_6,/*!<  PBFR6: USBA_VBUSEN    */
} gpio_pb2_func_t;
...
typedef enum {
    ...
    GPIO_PB3_USBA_ID    = GPIO_FR_6, /*!< PBFR6: USBA_ID        */
} gpio_pb3_func_t;
...
typedef enum {
    ...
    GPIO_PE0_CANBTX     = GPIO_FR_6,  /*!< PCFR6: CANBTX         */
...
typedef enum {
    ...
    GPIO_PE1_CANBRX     = GPIO_FR_6,  /*!< PCFR6: CANBRX         */
...
typedef enum {
    ...
    GPIO_PE2_EMAPPSOUT0 = GPIO_FR_6,  /*!< PCFR6: EMAPPSOUT0     */
...
typedef enum {
    ...
    GPIO_PE3_EMAPPSOUT1 = GPIO_FR_6,  /*!< PCFR5: EMAPPSOUT1     */
...
typedef enum {
    ...
    GPIO_PF5_USBB_SOF_TGL = GPIO_FR_6,  /*!< PCFR6: USBB_SOF_TGL     */
} gpio_pf5_func_t;
...
typedef enum {
    ...
    GPIO_PF6_CANATX  = GPIO_FR_6,  /*!< PCFR6: CANATX       */
} gpio_pf6_func_t;
...
typedef enum {
    ...
    GPIO_PF7_CANARX   = GPIO_FR_6, /*!< PCFR6: CANARX       */
} gpio_pf7_func_t;
...
typedef enum {
    ...
    GPIO_PG0_EMARXDV = GPIO_FR_8,  /*!< PCFR8: EMARXDV      */
} gpio_pg0_func_t;
...
typedef enum {
    ...
    GPIO_PG1_EMARXER = GPIO_FR_8,  /*!< PCFR8: EMARXER      */
} gpio_pg1_func_t;
...
typedef enum {
    ...
    GPIO_PG2_EMACRS   = GPIO_FR_8,  /*!< PCFR8: EMACRS       */
} gpio_pg2_func_t;
...
typedef enum {
    ...
    GPIO_PG3_EMACOL   = GPIO_FR_8,  /*!< PCFR8: EMACOL       */
} gpio_pg3_func_t;
...
typedef enum {
    ...
    GPIO_PG4_EMARXD2    = GPIO_FR_8,  /*!< PCFR8: EMARXD2      */
} gpio_pg4_func_t;
...
typedef enum {
    ...
    GPIO_PG5_EMARXD3      = GPIO_FR_8,  /*!< PCFR8: EMARXD3      */
} gpio_pg5_func_t;
...
typedef enum {
    ...
    GPIO_PG7_EMAMDC       = GPIO_FR_8,  /*!< PCFR8: EMAMDC       */
} gpio_pg7_func_t;
...
typedef enum {
    ...
    GPIO_PH0_EMAMDIO    = GPIO_FR_8,  /*!< PCFR8: EMAMDIO      */
} gpio_ph0_func_t;
...
typedef enum {
    ...
    GPIO_PK0_EMATXEN    = GPIO_FR_8, /*!< PKFR8: EMATXEN        */
} gpio_pk0_func_t;
...
typedef enum {
    ...
    GPIO_PK2_EMAMDC     = GPIO_FR_8, /*!< PKFR8: EMAMDC         */
} gpio_pk2_func_t;
...
typedef enum {
    ...
    GPIO_PK3_EMAMDIO    = GPIO_FR_8, /*!< PKFR8: EMAMDIO        */
} gpio_pk3_func_t;
...
typedef enum {
    ...
    GPIO_PK4_EMATXCLK    = GPIO_FR_8, /*!< PKFR8: EMATXCLK       */
} gpio_pk4_func_t;
...
typedef enum {
    ...
    GPIO_PK5_EMATXD3    = GPIO_FR_8, /*!< PKFR8: EMATXD3        */
} gpio_pk5_func_t;
...
typedef enum {
    ...
    GPIO_PK6_EMATXD2    = GPIO_FR_8, /*!< PKFR8: EMATXD2        */
} gpio_pk6_func_t;
...
typedef enum {
    ...
    GPIO_PK7_EMATXD1    = GPIO_FR_8, /*!< PKFR8: EMATXD1        */
} gpio_pk7_func_t;
...
typedef enum {
    ...
    GPIO_PL0_EMATXD0    = GPIO_FR_8, /*!< PKFR8: EMATXD0        */
} gpio_pl0_func_t;
...
typedef enum {
    ...
    GPIO_PL1_EMARXCLK  = GPIO_FR_8, /*!< PLFR8: EMARXCLK       */
} gpio_pl1_func_t;
...
typedef enum {
    ...
    GPIO_PL2_EMARXD0    = GPIO_FR_8, /*!< PLFR8: EMARXD0        */
} gpio_pl2_func_t;
...
typedef enum {
    ...
    GPIO_PL3_EMARXD1    = GPIO_FR_8, /*!< PLFR8: EMARXD1        */
} gpio_pl3_func_t;
...
typedef enum {
    ...
    GPIO_PM0_EMATXD3    = GPIO_FR_8, /*!< PMFR8: EMATXD3        */
} gpio_pm0_func_t;
...
typedef enum {
    ...
    GPIO_PM1_USBB_SOF_TQL = GPIO_FR_3, /*!< PMFR3: USBB_SOF_TQL */
    ...
    GPIO_PM1_EMATXD2    = GPIO_FR_8, /*!< PMFR8: EMATXD2        */
} gpio_pm1_func_t;
...
typedef enum {
    ...
    GPIO_PM2_EMATXD1    = GPIO_FR_8, /*!< PMFR8: EMATXD1        */
} gpio_pm2_func_t;
...
typedef enum {
    ...
    GPIO_PM3_EMATXD0    = GPIO_FR_8, /*!< PMFR8: EMATXD0        */
} gpio_pm3_func_t;
...
typedef enum {
    ...
    GPIO_PT4_EMATXCLK   = GPIO_FR_8, /*!< PTFR8: EMATXCLK       */
} gpio_pt4_func_t;
...
typedef enum {
    ...
    GPIO_PU0_USBB_ID    = GPIO_FR_5, /*!< PUFR5: USBB_ID        */
...
typedef enum {
    ...
    GPIO_PU3_USBB_VBUSEN = GPIO_FR_5,/*!< PUFR5: USBB_VBUSEN    */
...
typedef enum {
    ...
    GPIO_PU6_CANBRX     = GPIO_FR_8, /*!< PUFR8: CANBRX         */
} gpio_pu6_func_t;
...
typedef enum {
    ...
    GPIO_PU7_CANBTX     = GPIO_FR_8, /*!< PUFR8: CANBTX         */
} gpio_pu7_func_t;
...
typedef enum {
    ...
    GPIO_PV0_EMARXD0    = GPIO_FR_8, /*!< PVFR8: EMARXD0        */
} gpio_pv0_func_t;
...
typedef enum {
    ...
    GPIO_PV1_EMARXD1    = GPIO_FR_8, /*!< PVFR8: EMARXD1        */
} gpio_pv1_func_t;
...
typedef enum {
    ...
    GPIO_PV2_EMARXD2    = GPIO_FR_8, /*!< PVFR8: EMARXD2        */
} gpio_pv2_func_t;
...
typedef enum {
    ...
    GPIO_PV3_EMARXD3    = GPIO_FR_8, /*!< PVFR8: EMARXD3        */
} gpio_pv3_func_t;
...
typedef enum {
    ...
    GPIO_PV4_CANATX     = GPIO_FR_8, /*!< PVFR8: CANATX         */
} gpio_pv4_func_t;
...
typedef enum {
    ...
    GPIO_PV5_CANARX     = GPIO_FR_8, /*!< PVFR8: CANARX         */
} gpio_pv5_func_t;
...
typedef enum {
    ...
    GPIO_PY4_USBA_SOF_TGL = GPIO_FR_6, /*!< PYFR6: USBA_SOF_TGL */
} gpio_py4_func_t;
