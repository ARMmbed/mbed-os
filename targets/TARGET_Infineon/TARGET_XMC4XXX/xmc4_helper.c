...
static pin_io_function_t P0_0 = {
    .pin_nbr = 0,
    .pin_port = 0,
    .usic0_ch0_dx0 = NOT_SUPPORTED,
    .usic0_ch1_dx0 = NOT_SUPPORTED,
    .usic1_ch0_dx0 = NOT_SUPPORTED,
    .usic1_ch1_dx0 = USIC1_C1_DX0_P0_0,
    .usic2_ch0_dx0 = NOT_SUPPORTED,
    .usic2_ch1_dx0 = NOT_SUPPORTED,
    .usic_select_line = NOT_SUPPORTED,
    .eru0_input    = 0xB0,
    .eru1_input    = NOT_SUPPORTED,
    .pwm_ccu8_channel = 1
};
...
static pin_io_function_t P0_7 = {
    ...
    .eru0_input    = 0xB1,
    .eru1_input    = NOT_SUPPORTED,
    .pwm_ccu8_channel = NOT_SUPPORTED
};
