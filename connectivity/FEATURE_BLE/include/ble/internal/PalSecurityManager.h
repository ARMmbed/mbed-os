...
/**
 * Handle events generated by ble::PalSecurityManager
 */
...
public:
     ...
     *
     * @note shall be followed by: PalSecurityManager::passkey_request_reply
     * @param[in] connection connection handle
...
public:
     ...
     * with a valid passkey alter this behaviour and the PalSecurityManager shall
