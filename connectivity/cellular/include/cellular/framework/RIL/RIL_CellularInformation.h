...
class RIL_CellularInformation: public CellularInformation, public RIL_CellularBase {
public:
...
public: // from CellularInformation
    ...
    virtual nsapi_error_t get_imsi(char *buf, size_t buf_size);

    virtual nsapi_error_t get_iccid(char *buf, size_t buf_size);

    virtual nsapi_error_t get_psmtimer(unsigned int *buf, size_t buf_size);
