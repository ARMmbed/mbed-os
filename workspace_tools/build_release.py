...
OFFICIAL_MBED_LIBRARY_BUILD = (
    ...
    ('NUCLEO_F030R8', ('ARM', 'uARM', 'GCC_ARM')),
    ('NUCLEO_F072RB', ('ARM', 'uARM', 'GCC_ARM')),
    ('NUCLEO_F091RC', ('ARM', 'uARM', 'GCC_ARM')),
    ('NUCLEO_F103RB', ('ARM', 'uARM', 'GCC_ARM')),
    ('NUCLEO_F302R8', ('ARM', 'uARM', 'GCC_ARM')),
    ('NUCLEO_F334R8', ('ARM', 'uARM', 'GCC_ARM')),
    ('NUCLEO_F401RE', ('ARM', 'uARM', 'GCC_ARM')),
    ('NUCLEO_F411RE', ('ARM', 'uARM', 'GCC_ARM')),
    ('NUCLEO_L053R8', ('ARM', 'uARM', 'GCC_ARM')),
    ('NUCLEO_L152RE', ('ARM', 'uARM', 'GCC_ARM')),
