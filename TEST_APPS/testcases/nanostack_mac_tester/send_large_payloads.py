...
class Testcase(Bench):
    ...
    def case(self):
        ...
        self.command("First",
                     "data --dst_addr 01:02:03:00:00:00:00:02 --msdu_length {} --msdu {}".format(len(large_payload),
                                                                                                 large_payload))
        self.command("Second", "wait --timeout 500")

        self.command("Second",
                     "data --dst_addr 01:02:03:00:00:00:00:01 --msdu_length {} --msdu {}".format(len(large_payload),
                                                                                                 large_payload))
