 ...
 #
 # This file is derivate of
 # https://github.com/ARMmbed/mbed-os/pull/8845/files/1cd5be43870db82a33769da292f8a81d5e52775c#diff-396ff5d89363cf2714eea423a3576d17
...
def musca_tfm_bin(t_self, mbed_ns_binary_file):
    ...
    musca_tfm_rel_path = join("targets", "TARGET_ARM_SSG", "TARGET_MUSCA_B1", "TFM")
    ...
    sys.argv = ['imgtool.py',
                ...
                '--align', '1', '-v', '1.0', '-H', '0x400', '--pad', '0x80000',
