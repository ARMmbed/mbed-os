...
function(mbed_generate_options_for_linker target definitions_file)
    ...
    # Remove macro definitions that contain spaces as the lack of escape
    # sequences and quotation marks in the macro when retrieved using generator
    # expressions causes linker errors. This includes string macros, array
    # macros, and macros with operations. TODO CMake: Add escape sequences and
    # quotation marks where necessary instead of removing these macros.
    set(_compile_definitions "$<FILTER:${_compile_definitions},EXCLUDE, +>")
    ...
    file(
        GENERATE
        OUTPUT "${CMAKE_BINARY_DIR}/compile_time_defs.txt"
        CONTENT "${_compile_definitions}\n"
    )
    set(${definitions_file}
        @${CMAKE_BINARY_DIR}/compile_time_defs.txt
        PARENT_SCOPE
    )
endfunction()
...
# Clear toolchains options for all languages as Mbed OS uses different
# initialisation options (such as for optimization and debug symbols)
